      SUBROUTINE smatrix_dxc_epmumvevmxdxc(P1,ANS)
C  
...
C  
      ...
      REAL*8 matrix_dxc_epmumvevmxdxc
...
C  
      ...
      common/to_amps_dxc_epmumvevmxdxc/  amp2,       jamp2
      ...
      common/to_matrix_dxc_epmumvevmxdxc/isum_hel, multi_channel
      INTEGER MAPCONFIG(0:LMAXCONFIGS), ICONFIG
      common/to_mconfigs_dxc_epmumvevmxdxc/mapconfig, iconfig
      DATA NTRY,IDUM /0,-1/
      integer iforest(2,-max_branch:-1,lmaxconfigs)
      common/to_forest_dxc_epmumvevmxdxc/ iforest
      include "configs.inc"
      ...
      IF (ISUM_HEL .EQ. 0 .OR. NTRY .LT. 10) THEN
          DO IHEL=1,NCOMB
              IF (GOODHEL(IHEL,IPROC) .OR. NTRY .LT. 2) THEN
                 T=matrix_dxc_epmumvevmxdxc(P ,NHEL(1,IHEL),JC(1))            
...
C                WRITE(*,*) ngood,IHEL,T
      ...
      REAL*8 FUNCTION matrix_dxc_epmumvevmxdxc(P,NHEL,IC)
C  
C Generated by MadGraph II Version 3.90. Updated 08/26/05               
C RETURNS AMPLITUDE SQUARED SUMMED/AVG OVER COLORS
...
C ----------
     ...
     &             +AMP(  11)+AMP(  12)+AMP(  13)+AMP(  14)
      matrix_dxc_epmumvevmxdxc = 0.D0 
      DO I = 1, NCOLOR
          ZTEMP = (0.D0,0.D0)
          DO J = 1, NCOLOR
              ZTEMP = ZTEMP + CF(J,I)*JAMP(J)
          ENDDO
          matrix_dxc_epmumvevmxdxc =matrix_dxc_epmumvevmxdxc+ZTEMP*DCONJG(JAMP(I))/DENOM(I)   
      ENDDO
      Do I = 1, NGRAPHS
