...
c -- find alambda corresponding to alphas given in first parameter
  ...
  10    continue
        ...
        call mrslambda(alpha,qz,alambda)
...
c - next call mrslambda to get alphas at q with the correct alambda
      call mrslambda(alpha,q,alambda)
      RETURN
      END
*
