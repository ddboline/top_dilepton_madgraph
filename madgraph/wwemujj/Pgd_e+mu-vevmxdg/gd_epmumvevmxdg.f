      SUBROUTINE smatrix_gd_epmumvevmxdg(P1,ANS)
C  
...
C  
C FOR PROCESS : g d -> e+ mu- ve vm~ d g  
C  
C Crossing   1 is g d -> e+ mu- ve vm~ d g  
      IMPLICIT NONE
C  
C CONSTANTS
C  
...
C  
      ...
      common/to_amps_gd_epmumvevmxdg/  amp2,       jamp2
      ...
      common/to_matrix_gd_epmumvevmxdg/isum_hel, multi_channel
      INTEGER MAPCONFIG(0:LMAXCONFIGS), ICONFIG
      common/to_mconfigs_gd_epmumvevmxdg/mapconfig, iconfig
      DATA NTRY,IDUM /0,-1/
      integer iforest(2,-max_branch:-1,lmaxconfigs)
      common/to_forest_gd_epmumvevmxdg/ iforest
      include "configs.inc"
      ...
      IF (ISUM_HEL .EQ. 0 .OR. NTRY .LT. 10) THEN
          DO IHEL=1,NCOMB
              IF (GOODHEL(IHEL,IPROC) .OR. NTRY .LT. 2) THEN
                 T=matrix_gd_epmumvevmxdg(P ,NHEL(1,IHEL),JC(1))            
...
C                WRITE(*,*) ngood,IHEL,T
      ...
      REAL*8 FUNCTION matrix_gd_epmumvevmxdg(P,NHEL,IC)
C  
C Generated by MadGraph II Version 3.90. Updated 08/26/05               
C RETURNS AMPLITUDE SQUARED SUMMED/AVG OVER COLORS
...
C ----------
      ...
      CALL FVOXXX(W(1,7   ),W(1,11  ),GG ,ZERO    ,ZERO    ,W(1,13  ))     
      ...
      CALL FVOXXX(W(1,17  ),W(1,1   ),GG ,ZERO    ,ZERO    ,W(1,18  ))     
      ...
      CALL FVOXXX(W(1,21  ),W(1,11  ),GG ,ZERO    ,ZERO    ,W(1,22  ))     
      CALL IOVXXX(W(1,2   ),W(1,22  ),W(1,10  ),GWF ,AMP(6   ))            
      CALL FVOXXX(W(1,21  ),W(1,1   ),GG ,ZERO    ,ZERO    ,W(1,23  ))     
      CALL IOVXXX(W(1,15  ),W(1,23  ),W(1,10  ),GWF ,AMP(7   ))            
      CALL FVOXXX(W(1,17  ),W(1,9   ),GWF ,ZERO    ,ZERO    ,W(1,24  ))    
      CALL IOVXXX(W(1,12  ),W(1,24  ),W(1,1   ),GG ,AMP(8   ))             
      CALL IOVXXX(W(1,12  ),W(1,23  ),W(1,8   ),GG ,AMP(9   ))             
      CALL FVOXXX(W(1,21  ),W(1,8   ),GG ,ZERO    ,ZERO    ,W(1,25  ))     
      CALL FVOXXX(W(1,25  ),W(1,1   ),GG ,ZERO    ,ZERO    ,W(1,26  ))     
      CALL IOVXXX(W(1,2   ),W(1,26  ),W(1,10  ),GWF ,AMP(10  ))            
      CALL JVVXXX(W(1,10  ),W(1,9   ),GWWA ,ZERO    ,AWIDTH  ,W(1,         
     &     27  ))                                                          
      CALL IOVXXX(W(1,2   ),W(1,13  ),W(1,27  ),GAD ,AMP(11  ))            
      CALL JVVXXX(W(1,10  ),W(1,9   ),GWWZ ,ZMASS   ,ZWIDTH  ,W(1,         
     &     28  ))                                                          
      CALL IOVXXX(W(1,2   ),W(1,13  ),W(1,28  ),GZD ,AMP(12  ))            
      CALL JIOXXX(W(1,15  ),W(1,14  ),GAD ,ZERO    ,AWIDTH  ,W(1,29  ))    
      CALL VVVXXX(W(1,10  ),W(1,9   ),W(1,29  ),GWWA ,AMP(13  ))           
      CALL JIOXXX(W(1,15  ),W(1,14  ),GZD ,ZMASS   ,ZWIDTH  ,W(1,30  ))    
      CALL VVVXXX(W(1,10  ),W(1,9   ),W(1,30  ),GWWZ ,AMP(14  ))           
      CALL IOVXXX(W(1,2   ),W(1,18  ),W(1,27  ),GAD ,AMP(15  ))            
      CALL IOVXXX(W(1,2   ),W(1,18  ),W(1,28  ),GZD ,AMP(16  ))            
      CALL JIOXXX(W(1,2   ),W(1,19  ),GAD ,ZERO    ,AWIDTH  ,W(1,31  ))    
      CALL VVVXXX(W(1,10  ),W(1,9   ),W(1,31  ),GWWA ,AMP(17  ))           
      CALL JIOXXX(W(1,2   ),W(1,19  ),GZD ,ZMASS   ,ZWIDTH  ,W(1,32  ))    
      CALL VVVXXX(W(1,10  ),W(1,9   ),W(1,32  ),GWWZ ,AMP(18  ))           
      CALL FVIXXX(W(1,2   ),W(1,11  ),GG ,ZERO    ,ZERO    ,W(1,33  ))     
      CALL IOVXXX(W(1,33  ),W(1,7   ),W(1,27  ),GAD ,AMP(19  ))            
      CALL IOVXXX(W(1,33  ),W(1,7   ),W(1,28  ),GZD ,AMP(20  ))            
      CALL FVIXXX(W(1,15  ),W(1,1   ),GG ,ZERO    ,ZERO    ,W(1,34  ))     
      CALL IOVXXX(W(1,34  ),W(1,7   ),W(1,27  ),GAD ,AMP(21  ))            
      CALL IOVXXX(W(1,34  ),W(1,7   ),W(1,28  ),GZD ,AMP(22  ))            
      CALL FVIXXX(W(1,2   ),W(1,1   ),GG ,ZERO    ,ZERO    ,W(1,35  ))     
      CALL IOVXXX(W(1,35  ),W(1,17  ),W(1,27  ),GAD ,AMP(23  ))            
      CALL IOVXXX(W(1,35  ),W(1,17  ),W(1,28  ),GZD ,AMP(24  ))            
      CALL FVIXXX(W(1,35  ),W(1,8   ),GG ,ZERO    ,ZERO    ,W(1,36  ))     
      CALL IOVXXX(W(1,36  ),W(1,7   ),W(1,27  ),GAD ,AMP(25  ))            
      CALL IOVXXX(W(1,36  ),W(1,7   ),W(1,28  ),GZD ,AMP(26  ))            
      CALL IOVXXX(W(1,33  ),W(1,21  ),W(1,10  ),GWF ,AMP(27  ))            
      CALL IOVXXX(W(1,34  ),W(1,21  ),W(1,10  ),GWF ,AMP(28  ))            
      CALL FVIXXX(W(1,35  ),W(1,10  ),GWF ,ZERO    ,ZERO    ,W(1,37  ))    
      CALL IOVXXX(W(1,37  ),W(1,17  ),W(1,9   ),GWF ,AMP(29  ))            
      CALL IOVXXX(W(1,36  ),W(1,21  ),W(1,10  ),GWF ,AMP(30  ))            
      CALL IOVXXX(W(1,35  ),W(1,25  ),W(1,10  ),GWF ,AMP(31  ))            
     ...
     &             +AMP(  27)+AMP(  29)+AMP(  30)+AMP(  31)
      matrix_gd_epmumvevmxdg = 0.D0 
      DO I = 1, NCOLOR
          ZTEMP = (0.D0,0.D0)
          DO J = 1, NCOLOR
              ZTEMP = ZTEMP + CF(J,I)*JAMP(J)
          ENDDO
          matrix_gd_epmumvevmxdg =matrix_gd_epmumvevmxdg+ZTEMP*DCONJG(JAMP(I))/DENOM(I)   
      ENDDO
      Do I = 1, NGRAPHS
