      SUBROUTINE smatrix_ucx_epmumvevmxdsx(P1,ANS)
C  
...
C  
C FOR PROCESS : u c~ -> e+ mu- ve vm~ d s~  
C  
C Crossing   1 is u c~ -> e+ mu- ve vm~ d s~  
      IMPLICIT NONE
C  
C CONSTANTS
C  
...
C  
      ...
      REAL*8 matrix_ucx_epmumvevmxdsx
...
C  
      ...
      common/to_amps_ucx_epmumvevmxdsx/  amp2,       jamp2
      ...
      common/to_matrix_ucx_epmumvevmxdsx/isum_hel, multi_channel
      INTEGER MAPCONFIG(0:LMAXCONFIGS), ICONFIG
      common/to_mconfigs_ucx_epmumvevmxdsx/mapconfig, iconfig
      DATA NTRY,IDUM /0,-1/
      integer iforest(2,-max_branch:-1,lmaxconfigs)
      common/to_forest_ucx_epmumvevmxdsx/ iforest
      include "configs.inc"
      ...
      IF (ISUM_HEL .EQ. 0 .OR. NTRY .LT. 10) THEN
          DO IHEL=1,NCOMB
              IF (GOODHEL(IHEL,IPROC) .OR. NTRY .LT. 2) THEN
                 T=matrix_ucx_epmumvevmxdsx(P ,NHEL(1,IHEL),JC(1))            
...
C                WRITE(*,*) ngood,IHEL,T
      ...
      REAL*8 FUNCTION matrix_ucx_epmumvevmxdsx(P,NHEL,IC)
C  
C Generated by MadGraph II Version 3.90. Updated 08/26/05               
C RETURNS AMPLITUDE SQUARED SUMMED/AVG OVER COLORS
...
C ----------
      ...
      CALL FVIXXX(W(1,1   ),W(1,9   ),GWF ,ZERO    ,ZERO    ,W(1,11  ))    
      CALL FVOXXX(W(1,2   ),W(1,10  ),GWF ,ZERO    ,ZERO    ,W(1,12  ))    
      CALL JIOXXX(W(1,11  ),W(1,7   ),GG ,ZERO    ,ZERO    ,W(1,13  ))     
      ...
      CALL IOVXXX(W(1,11  ),W(1,7   ),W(1,15  ),GG ,AMP(2   ))             
      ...
      matrix_ucx_epmumvevmxdsx = 0.D0 
      DO I = 1, NCOLOR
          ZTEMP = (0.D0,0.D0)
          DO J = 1, NCOLOR
              ZTEMP = ZTEMP + CF(J,I)*JAMP(J)
          ENDDO
          matrix_ucx_epmumvevmxdsx =matrix_ucx_epmumvevmxdsx+ZTEMP*DCONJG(JAMP(I))/DENOM(I)   
      ENDDO
      Do I = 1, NGRAPHS
