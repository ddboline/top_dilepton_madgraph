      SUBROUTINE smatrix_sxux_epmumvevmxdxcx(P1,ANS)
C  
...
C  
C FOR PROCESS : s~ u~ -> e+ mu- ve vm~ d~ c~  
C  
C Crossing   1 is s~ u~ -> e+ mu- ve vm~ d~ c~  
      IMPLICIT NONE
C  
C CONSTANTS
C  
...
C  
      ...
      REAL*8 matrix_sxux_epmumvevmxdxcx
...
C  
      ...
      common/to_amps_sxux_epmumvevmxdxcx/  amp2,       jamp2
      ...
      common/to_matrix_sxux_epmumvevmxdxcx/isum_hel, multi_channel
      INTEGER MAPCONFIG(0:LMAXCONFIGS), ICONFIG
      common/to_mconfigs_sxux_epmumvevmxdxcx/mapconfig, iconfig
      DATA NTRY,IDUM /0,-1/
      integer iforest(2,-max_branch:-1,lmaxconfigs)
      common/to_forest_sxux_epmumvevmxdxcx/ iforest
      include "configs.inc"
      ...
      IF (ISUM_HEL .EQ. 0 .OR. NTRY .LT. 10) THEN
          DO IHEL=1,NCOMB
              IF (GOODHEL(IHEL,IPROC) .OR. NTRY .LT. 2) THEN
                 T=matrix_sxux_epmumvevmxdxcx(P ,NHEL(1,IHEL),JC(1))            
...
C                WRITE(*,*) ngood,IHEL,T
      ...
      REAL*8 FUNCTION matrix_sxux_epmumvevmxdxcx(P,NHEL,IC)
C  
C Generated by MadGraph II Version 3.90. Updated 08/26/05               
C RETURNS AMPLITUDE SQUARED SUMMED/AVG OVER COLORS
...
C ----------
      ...
      CALL FVOXXX(W(1,2   ),W(1,10  ),GWF ,ZERO    ,ZERO    ,W(1,13  ))    
      CALL IOVXXX(W(1,7   ),W(1,13  ),W(1,12  ),GG ,AMP(1   ))             
      CALL FVOXXX(W(1,1   ),W(1,9   ),GWF ,ZERO    ,ZERO    ,W(1,14  ))    
      CALL JIOXXX(W(1,7   ),W(1,13  ),GG ,ZERO    ,ZERO    ,W(1,15  ))     
      CALL IOVXXX(W(1,8   ),W(1,14  ),W(1,15  ),GG ,AMP(2   ))             
      CALL FVIXXX(W(1,7   ),W(1,10  ),GWF ,ZERO    ,ZERO    ,W(1,16  ))    
      CALL JIOXXX(W(1,16  ),W(1,2   ),GG ,ZERO    ,ZERO    ,W(1,17  ))     
      CALL IOVXXX(W(1,8   ),W(1,14  ),W(1,17  ),GG ,AMP(3   ))             
      CALL IOVXXX(W(1,16  ),W(1,2   ),W(1,12  ),GG ,AMP(4   ))             
      JAMP(   1) = +AMP(   1)+AMP(   2)+AMP(   3)+AMP(   4)
      matrix_sxux_epmumvevmxdxcx = 0.D0 
      DO I = 1, NCOLOR
          ZTEMP = (0.D0,0.D0)
          DO J = 1, NCOLOR
              ZTEMP = ZTEMP + CF(J,I)*JAMP(J)
          ENDDO
          matrix_sxux_epmumvevmxdxcx =matrix_sxux_epmumvevmxdxcx+ZTEMP*DCONJG(JAMP(I))/DENOM(I)   
      ENDDO
      Do I = 1, NGRAPHS
