      SUBROUTINE smatrix_dd_epmumvevmxdd(P1,ANS)
C  
...
C  
C FOR PROCESS : d d -> e+ mu- ve vm~ d d  
C  
C Crossing   1 is d d -> e+ mu- ve vm~ d d  
      IMPLICIT NONE
C  
C CONSTANTS
C  
...
C  
      ...
      common/to_amps_dd_epmumvevmxdd/  amp2,       jamp2
      ...
      common/to_matrix_dd_epmumvevmxdd/isum_hel, multi_channel
      INTEGER MAPCONFIG(0:LMAXCONFIGS), ICONFIG
      common/to_mconfigs_dd_epmumvevmxdd/mapconfig, iconfig
      DATA NTRY,IDUM /0,-1/
      integer iforest(2,-max_branch:-1,lmaxconfigs)
      common/to_forest_dd_epmumvevmxdd/ iforest
      include "configs.inc"
      ...
      IF (ISUM_HEL .EQ. 0 .OR. NTRY .LT. 10) THEN
          DO IHEL=1,NCOMB
              IF (GOODHEL(IHEL,IPROC) .OR. NTRY .LT. 2) THEN
                 T=matrix_dd_epmumvevmxdd(P ,NHEL(1,IHEL),JC(1))            
...
C                WRITE(*,*) ngood,IHEL,T
      ...
      REAL*8 FUNCTION matrix_dd_epmumvevmxdd(P,NHEL,IC)
C  
C Generated by MadGraph II Version 3.90. Updated 08/26/05               
C RETURNS AMPLITUDE SQUARED SUMMED/AVG OVER COLORS
...
C ----------
      ...
      CALL FVIXXX(W(1,1   ),W(1,10  ),GWF ,ZERO    ,ZERO    ,W(1,12  ))    
      ...
      CALL FVOXXX(W(1,14  ),W(1,11  ),GG ,ZERO    ,ZERO    ,W(1,15  ))     
      CALL IOVXXX(W(1,1   ),W(1,15  ),W(1,10  ),GWF ,AMP(2   ))            
      CALL JIOXXX(W(1,1   ),W(1,7   ),GG ,ZERO    ,ZERO    ,W(1,16  ))     
      CALL FVOXXX(W(1,8   ),W(1,9   ),GWF ,ZERO    ,ZERO    ,W(1,17  ))    
      CALL FVOXXX(W(1,17  ),W(1,16  ),GG ,ZERO    ,ZERO    ,W(1,18  ))     
      CALL IOVXXX(W(1,2   ),W(1,18  ),W(1,10  ),GWF ,AMP(3   ))            
      CALL FVOXXX(W(1,8   ),W(1,16  ),GG ,ZERO    ,ZERO    ,W(1,19  ))     
      CALL FVOXXX(W(1,19  ),W(1,9   ),GWF ,ZERO    ,ZERO    ,W(1,20  ))    
      CALL IOVXXX(W(1,2   ),W(1,20  ),W(1,10  ),GWF ,AMP(4   ))            
      CALL FVIXXX(W(1,2   ),W(1,16  ),GG ,ZERO    ,ZERO    ,W(1,21  ))     
      CALL JVVXXX(W(1,10  ),W(1,9   ),GWWA ,ZERO    ,AWIDTH  ,W(1,         
     &     22  ))                                                          
      CALL IOVXXX(W(1,21  ),W(1,8   ),W(1,22  ),GAD ,AMP(5   ))            
      CALL JVVXXX(W(1,10  ),W(1,9   ),GWWZ ,ZMASS   ,ZWIDTH  ,W(1,         
     &     23  ))                                                          
      CALL IOVXXX(W(1,21  ),W(1,8   ),W(1,23  ),GZD ,AMP(6   ))            
      CALL IOVXXX(W(1,21  ),W(1,17  ),W(1,10  ),GWF ,AMP(7   ))            
      CALL JIOXXX(W(1,2   ),W(1,19  ),GAD ,ZERO    ,AWIDTH  ,W(1,24  ))    
      CALL VVVXXX(W(1,10  ),W(1,9   ),W(1,24  ),GWWA ,AMP(8   ))           
      CALL JIOXXX(W(1,2   ),W(1,19  ),GZD ,ZMASS   ,ZWIDTH  ,W(1,25  ))    
      CALL VVVXXX(W(1,10  ),W(1,9   ),W(1,25  ),GWWZ ,AMP(9   ))           
      CALL IOVXXX(W(1,1   ),W(1,13  ),W(1,22  ),GAD ,AMP(10  ))            
      CALL IOVXXX(W(1,1   ),W(1,13  ),W(1,23  ),GZD ,AMP(11  ))            
      CALL FVIXXX(W(1,1   ),W(1,11  ),GG ,ZERO    ,ZERO    ,W(1,26  ))     
      CALL IOVXXX(W(1,26  ),W(1,7   ),W(1,22  ),GAD ,AMP(12  ))            
      CALL IOVXXX(W(1,26  ),W(1,7   ),W(1,23  ),GZD ,AMP(13  ))            
      CALL IOVXXX(W(1,26  ),W(1,14  ),W(1,10  ),GWF ,AMP(14  ))            
      CALL JIOXXX(W(1,2   ),W(1,7   ),GG ,ZERO    ,ZERO    ,W(1,27  ))     
      CALL FVOXXX(W(1,17  ),W(1,27  ),GG ,ZERO    ,ZERO    ,W(1,28  ))     
      CALL IOVXXX(W(1,1   ),W(1,28  ),W(1,10  ),GWF ,AMP(15  ))            
      CALL FVOXXX(W(1,8   ),W(1,27  ),GG ,ZERO    ,ZERO    ,W(1,29  ))     
      CALL FVOXXX(W(1,29  ),W(1,9   ),GWF ,ZERO    ,ZERO    ,W(1,30  ))    
      CALL IOVXXX(W(1,1   ),W(1,30  ),W(1,10  ),GWF ,AMP(16  ))            
      CALL JIOXXX(W(1,1   ),W(1,8   ),GG ,ZERO    ,ZERO    ,W(1,31  ))     
      CALL FVIXXX(W(1,2   ),W(1,10  ),GWF ,ZERO    ,ZERO    ,W(1,32  ))    
      CALL FVOXXX(W(1,7   ),W(1,31  ),GG ,ZERO    ,ZERO    ,W(1,33  ))     
      CALL IOVXXX(W(1,32  ),W(1,33  ),W(1,9   ),GWF ,AMP(17  ))            
      CALL FVOXXX(W(1,14  ),W(1,31  ),GG ,ZERO    ,ZERO    ,W(1,34  ))     
      CALL IOVXXX(W(1,2   ),W(1,34  ),W(1,10  ),GWF ,AMP(18  ))            
      CALL IOVXXX(W(1,2   ),W(1,33  ),W(1,22  ),GAD ,AMP(19  ))            
      CALL IOVXXX(W(1,2   ),W(1,33  ),W(1,23  ),GZD ,AMP(20  ))            
      CALL FVIXXX(W(1,1   ),W(1,27  ),GG ,ZERO    ,ZERO    ,W(1,35  ))     
      CALL IOVXXX(W(1,35  ),W(1,8   ),W(1,22  ),GAD ,AMP(21  ))            
      CALL IOVXXX(W(1,35  ),W(1,8   ),W(1,23  ),GZD ,AMP(22  ))            
      CALL IOVXXX(W(1,35  ),W(1,17  ),W(1,10  ),GWF ,AMP(23  ))            
      CALL JIOXXX(W(1,1   ),W(1,29  ),GAD ,ZERO    ,AWIDTH  ,W(1,36  ))    
      CALL VVVXXX(W(1,10  ),W(1,9   ),W(1,36  ),GWWA ,AMP(24  ))           
      CALL JIOXXX(W(1,1   ),W(1,29  ),GZD ,ZMASS   ,ZWIDTH  ,W(1,37  ))    
      CALL VVVXXX(W(1,10  ),W(1,9   ),W(1,37  ),GWWZ ,AMP(25  ))           
      CALL FVIXXX(W(1,2   ),W(1,31  ),GG ,ZERO    ,ZERO    ,W(1,38  ))     
      CALL IOVXXX(W(1,38  ),W(1,7   ),W(1,22  ),GAD ,AMP(26  ))            
      CALL IOVXXX(W(1,38  ),W(1,7   ),W(1,23  ),GZD ,AMP(27  ))            
      CALL IOVXXX(W(1,38  ),W(1,14  ),W(1,10  ),GWF ,AMP(28  ))            
     ...
     &             +AMP(  25)+AMP(  26)+AMP(  27)+AMP(  28)
      matrix_dd_epmumvevmxdd = 0.D0 
      DO I = 1, NCOLOR
          ZTEMP = (0.D0,0.D0)
          DO J = 1, NCOLOR
              ZTEMP = ZTEMP + CF(J,I)*JAMP(J)
          ENDDO
          matrix_dd_epmumvevmxdd =matrix_dd_epmumvevmxdd+ZTEMP*DCONJG(JAMP(I))/DENOM(I)   
      ENDDO
      Do I = 1, NGRAPHS
