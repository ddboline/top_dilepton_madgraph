      SUBROUTINE smatrix_uux_epvemumvmxbbx(P1,ANS)
C  
...
C  
C FOR PROCESS : u u~ -> e+ ve mu- vm~ b b~  
C  
C Crossing   1 is u u~ -> e+ ve mu- vm~ b b~  
      IMPLICIT NONE
C  
C CONSTANTS
C  
...
C  
      ...
      REAL*8 matrix_uux_epvemumvmxbbx
...
C  
      ...
      common/to_amps_uux_epvemumvmxbbx/  amp2,       jamp2
      ...
      common/to_matrix_uux_epvemumvmxbbx/isum_hel, multi_channel
      INTEGER MAPCONFIG(0:LMAXCONFIGS), ICONFIG
      common/to_mconfigs_uux_epvemumvmxbbx/mapconfig, iconfig
      DATA NTRY,IDUM /0,-1/
      integer iforest(2,-max_branch:-1,lmaxconfigs)
      common/to_forest_uux_epvemumvmxbbx/ iforest
      include "configs.inc"
      ...
      IF (ISUM_HEL .EQ. 0 .OR. NTRY .LT. 10) THEN
          DO IHEL=1,NCOMB
              IF (GOODHEL(IHEL,IPROC) .OR. NTRY .LT. 2) THEN
                 T=matrix_uux_epvemumvmxbbx(P ,NHEL(1,IHEL),JC(1))            
...
C                WRITE(*,*) ngood,IHEL,T
      ...
      REAL*8 FUNCTION matrix_uux_epvemumvmxbbx(P,NHEL,IC)
C  
C Generated by MadGraph II Version 3.90. Updated 08/26/05               
C RETURNS AMPLITUDE SQUARED SUMMED/AVG OVER COLORS
...
C ----------
      ...
      CALL FVOXXX(W(1,7   ),W(1,10  ),GWF ,TMASS   ,TWIDTH  ,W(1,12  ))    
      CALL FVIXXX(W(1,8   ),W(1,11  ),GWF ,TMASS   ,TWIDTH  ,W(1,13  ))    
      CALL IOVXXX(W(1,13  ),W(1,12  ),W(1,9   ),GG ,AMP(1   ))             
      JAMP(   1) = +AMP(   1)
      matrix_uux_epvemumvmxbbx = 0.D0 
      DO I = 1, NCOLOR
          ZTEMP = (0.D0,0.D0)
          DO J = 1, NCOLOR
              ZTEMP = ZTEMP + CF(J,I)*JAMP(J)
          ENDDO
          matrix_uux_epvemumvmxbbx =matrix_uux_epvemumvmxbbx+ZTEMP*DCONJG(JAMP(I))/DENOM(I)   
      ENDDO
      Do I = 1, NGRAPHS
