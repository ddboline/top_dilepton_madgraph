      SUBROUTINE smatrix_du_epmumvevmxud(P1,ANS)
C  
...
C  
      ...
      common/to_amps_du_epmumvevmxud/  amp2,       jamp2
      ...
      common/to_matrix_du_epmumvevmxud/isum_hel, multi_channel
      INTEGER MAPCONFIG(0:LMAXCONFIGS), ICONFIG
      common/to_mconfigs_du_epmumvevmxud/mapconfig, iconfig
      DATA NTRY,IDUM /0,-1/
      integer iforest(2,-max_branch:-1,lmaxconfigs)
      common/to_forest_du_epmumvevmxud/ iforest
      include "configs.inc"
      ...
      IF (ISUM_HEL .EQ. 0 .OR. NTRY .LT. 10) THEN
          DO IHEL=1,NCOMB
              IF (GOODHEL(IHEL,IPROC) .OR. NTRY .LT. 2) THEN
                 T=matrix_du_epmumvevmxud(P ,NHEL(1,IHEL),JC(1))            
...
C                WRITE(*,*) ngood,IHEL,T
      ...
      REAL*8 FUNCTION matrix_du_epmumvevmxud(P,NHEL,IC)
C  
C Generated by MadGraph II Version 3.90. Updated 08/26/05               
C RETURNS AMPLITUDE SQUARED SUMMED/AVG OVER COLORS
...
C ----------
     ...
     &     22  ))                                                          
      ...
      CALL FVIXXX(W(1,1   ),W(1,14  ),GG ,ZERO    ,ZERO    ,W(1,23  ))     
      CALL IOVXXX(W(1,23  ),W(1,8   ),W(1,20  ),GAD ,AMP(7   ))            
      CALL IOVXXX(W(1,23  ),W(1,8   ),W(1,22  ),GZD ,AMP(8   ))            
      CALL IOVXXX(W(1,23  ),W(1,15  ),W(1,10  ),GWF ,AMP(9   ))            
      CALL JIOXXX(W(1,1   ),W(1,17  ),GAD ,ZERO    ,AWIDTH  ,W(1,24  ))    
      CALL VVVXXX(W(1,10  ),W(1,9   ),W(1,24  ),GWWA ,AMP(10  ))           
      CALL JIOXXX(W(1,1   ),W(1,17  ),GZD ,ZMASS   ,ZWIDTH  ,W(1,25  ))    
      ...
      CALL FVIXXX(W(1,1   ),W(1,10  ),GWF ,ZERO    ,ZERO    ,W(1,28  ))    
      CALL IOVXXX(W(1,28  ),W(1,7   ),W(1,27  ),GG ,AMP(15  ))             
      CALL JIOXXX(W(1,28  ),W(1,7   ),GG ,ZERO    ,ZERO    ,W(1,29  ))     
      CALL IOVXXX(W(1,12  ),W(1,8   ),W(1,29  ),GG ,AMP(16  ))             
      CALL JIOXXX(W(1,1   ),W(1,19  ),GG ,ZERO    ,ZERO    ,W(1,30  ))     
      CALL IOVXXX(W(1,12  ),W(1,8   ),W(1,30  ),GG ,AMP(17  ))             
      CALL IOVXXX(W(1,1   ),W(1,19  ),W(1,27  ),GG ,AMP(18  ))             
      JAMP(   1) = +AMP(   1)+AMP(   2)+AMP(   3)+AMP(   4)+AMP(   5)
     &             +AMP(   6)+AMP(   7)+AMP(   8)+AMP(   9)+AMP(  10)
     &             +AMP(  11)+AMP(  12)+AMP(  13)+AMP(  14)
      JAMP(   2) = -AMP(  15)-AMP(  16)-AMP(  17)-AMP(  18)
      matrix_du_epmumvevmxud = 0.D0 
      DO I = 1, NCOLOR
          ZTEMP = (0.D0,0.D0)
          DO J = 1, NCOLOR
              ZTEMP = ZTEMP + CF(J,I)*JAMP(J)
          ENDDO
          matrix_du_epmumvevmxud =matrix_du_epmumvevmxud+ZTEMP*DCONJG(JAMP(I))/DENOM(I)   
      ENDDO
      Do I = 1, NGRAPHS
