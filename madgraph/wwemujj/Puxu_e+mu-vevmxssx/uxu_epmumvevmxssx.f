      SUBROUTINE smatrix_uxu_epmumvevmxssx(P1,ANS)
C  
...
C  
C FOR PROCESS : u~ u -> e+ mu- ve vm~ s s~  
C  
C Crossing   1 is u~ u -> e+ mu- ve vm~ s s~  
      IMPLICIT NONE
C  
C CONSTANTS
C  
...
C  
      ...
      REAL*8 matrix_uxu_epmumvevmxssx
...
C  
      ...
      common/to_amps_uxu_epmumvevmxssx/  amp2,       jamp2
      ...
      common/to_matrix_uxu_epmumvevmxssx/isum_hel, multi_channel
      INTEGER MAPCONFIG(0:LMAXCONFIGS), ICONFIG
      common/to_mconfigs_uxu_epmumvevmxssx/mapconfig, iconfig
      DATA NTRY,IDUM /0,-1/
      integer iforest(2,-max_branch:-1,lmaxconfigs)
      common/to_forest_uxu_epmumvevmxssx/ iforest
      include "configs.inc"
      ...
      IF (ISUM_HEL .EQ. 0 .OR. NTRY .LT. 10) THEN
          DO IHEL=1,NCOMB
              IF (GOODHEL(IHEL,IPROC) .OR. NTRY .LT. 2) THEN
                 T=matrix_uxu_epmumvevmxssx(P ,NHEL(1,IHEL),JC(1))            
...
C                WRITE(*,*) ngood,IHEL,T
      ...
      REAL*8 FUNCTION matrix_uxu_epmumvevmxssx(P,NHEL,IC)
C  
C Generated by MadGraph II Version 3.90. Updated 08/26/05               
C RETURNS AMPLITUDE SQUARED SUMMED/AVG OVER COLORS
...
C ----------
     ...
     &             +AMP(  11)+AMP(  12)+AMP(  13)+AMP(  14)
      matrix_uxu_epmumvevmxssx = 0.D0 
      DO I = 1, NCOLOR
          ZTEMP = (0.D0,0.D0)
          DO J = 1, NCOLOR
              ZTEMP = ZTEMP + CF(J,I)*JAMP(J)
          ENDDO
          matrix_uxu_epmumvevmxssx =matrix_uxu_epmumvevmxssx+ZTEMP*DCONJG(JAMP(I))/DENOM(I)   
      ENDDO
      Do I = 1, NGRAPHS
