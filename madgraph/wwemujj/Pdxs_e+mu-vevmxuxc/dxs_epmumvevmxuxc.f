      SUBROUTINE smatrix_dxs_epmumvevmxuxc(P1,ANS)
C  
...
C  
C FOR PROCESS : d~ s -> e+ mu- ve vm~ u~ c  
C  
C Crossing   1 is d~ s -> e+ mu- ve vm~ u~ c  
      IMPLICIT NONE
C  
C CONSTANTS
C  
...
C  
      ...
      REAL*8 matrix_dxs_epmumvevmxuxc
...
C  
      ...
      common/to_amps_dxs_epmumvevmxuxc/  amp2,       jamp2
      ...
      common/to_matrix_dxs_epmumvevmxuxc/isum_hel, multi_channel
      INTEGER MAPCONFIG(0:LMAXCONFIGS), ICONFIG
      common/to_mconfigs_dxs_epmumvevmxuxc/mapconfig, iconfig
      DATA NTRY,IDUM /0,-1/
      integer iforest(2,-max_branch:-1,lmaxconfigs)
      common/to_forest_dxs_epmumvevmxuxc/ iforest
      include "configs.inc"
      ...
      IF (ISUM_HEL .EQ. 0 .OR. NTRY .LT. 10) THEN
          DO IHEL=1,NCOMB
              IF (GOODHEL(IHEL,IPROC) .OR. NTRY .LT. 2) THEN
                 T=matrix_dxs_epmumvevmxuxc(P ,NHEL(1,IHEL),JC(1))            
...
C                WRITE(*,*) ngood,IHEL,T
      ...
      REAL*8 FUNCTION matrix_dxs_epmumvevmxuxc(P,NHEL,IC)
C  
C Generated by MadGraph II Version 3.90. Updated 08/26/05               
C RETURNS AMPLITUDE SQUARED SUMMED/AVG OVER COLORS
...
C ----------
      ...
      CALL IOVXXX(W(1,12  ),W(1,8   ),W(1,13  ),GG ,AMP(1   ))             
      CALL FVOXXX(W(1,8   ),W(1,10  ),GWF ,ZERO    ,ZERO    ,W(1,14  ))    
      ...
      CALL IOVXXX(W(1,12  ),W(1,8   ),W(1,17  ),GG ,AMP(3   ))             
      CALL IOVXXX(W(1,2   ),W(1,14  ),W(1,17  ),GG ,AMP(4   ))             
      JAMP(   1) = +AMP(   1)+AMP(   2)+AMP(   3)+AMP(   4)
      matrix_dxs_epmumvevmxuxc = 0.D0 
      DO I = 1, NCOLOR
          ZTEMP = (0.D0,0.D0)
          DO J = 1, NCOLOR
              ZTEMP = ZTEMP + CF(J,I)*JAMP(J)
          ENDDO
          matrix_dxs_epmumvevmxuxc =matrix_dxs_epmumvevmxuxc+ZTEMP*DCONJG(JAMP(I))/DENOM(I)   
      ENDDO
      Do I = 1, NGRAPHS
