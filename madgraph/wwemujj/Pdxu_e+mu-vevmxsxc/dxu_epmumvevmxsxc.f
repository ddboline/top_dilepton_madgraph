      SUBROUTINE smatrix_dxu_epmumvevmxsxc(P1,ANS)
C  
...
C  
      ...
      REAL*8 matrix_dxu_epmumvevmxsxc
...
C  
      ...
      common/to_amps_dxu_epmumvevmxsxc/  amp2,       jamp2
      ...
      common/to_matrix_dxu_epmumvevmxsxc/isum_hel, multi_channel
      INTEGER MAPCONFIG(0:LMAXCONFIGS), ICONFIG
      common/to_mconfigs_dxu_epmumvevmxsxc/mapconfig, iconfig
      DATA NTRY,IDUM /0,-1/
      integer iforest(2,-max_branch:-1,lmaxconfigs)
      common/to_forest_dxu_epmumvevmxsxc/ iforest
      include "configs.inc"
      ...
      IF (ISUM_HEL .EQ. 0 .OR. NTRY .LT. 10) THEN
          DO IHEL=1,NCOMB
              IF (GOODHEL(IHEL,IPROC) .OR. NTRY .LT. 2) THEN
                 T=matrix_dxu_epmumvevmxsxc(P ,NHEL(1,IHEL),JC(1))            
...
C                WRITE(*,*) ngood,IHEL,T
      ...
      REAL*8 FUNCTION matrix_dxu_epmumvevmxsxc(P,NHEL,IC)
C  
C Generated by MadGraph II Version 3.90. Updated 08/26/05               
C RETURNS AMPLITUDE SQUARED SUMMED/AVG OVER COLORS
...
C ----------
      ...
      CALL IOVXXX(W(1,7   ),W(1,11  ),W(1,17  ),GG ,AMP(3   ))             
      CALL IOVXXX(W(1,2   ),W(1,16  ),W(1,15  ),GG ,AMP(4   ))             
      JAMP(   1) = -AMP(   1)-AMP(   2)-AMP(   3)-AMP(   4)
      matrix_dxu_epmumvevmxsxc = 0.D0 
      DO I = 1, NCOLOR
          ZTEMP = (0.D0,0.D0)
          DO J = 1, NCOLOR
              ZTEMP = ZTEMP + CF(J,I)*JAMP(J)
          ENDDO
          matrix_dxu_epmumvevmxsxc =matrix_dxu_epmumvevmxsxc+ZTEMP*DCONJG(JAMP(I))/DENOM(I)   
      ENDDO
      Do I = 1, NGRAPHS
