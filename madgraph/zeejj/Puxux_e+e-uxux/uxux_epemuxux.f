      SUBROUTINE smatrix_uxux_epemuxux(P1,ANS)
C  
...
C  
      ...
      common/to_amps_uxux_epemuxux/  amp2,       jamp2
      ...
      common/to_matrix_uxux_epemuxux/isum_hel, multi_channel
      INTEGER MAPCONFIG(0:LMAXCONFIGS), ICONFIG
      common/to_mconfigs_uxux_epemuxux/mapconfig, iconfig
      DATA NTRY,IDUM /0,-1/
      integer iforest(2,-max_branch:-1,lmaxconfigs)
      common/to_forest_uxux_epemuxux/ iforest
      include "configs.inc"
      ...
      IF (ISUM_HEL .EQ. 0 .OR. NTRY .LT. 10) THEN
          DO IHEL=1,NCOMB
              IF (GOODHEL(IHEL,IPROC) .OR. NTRY .LT. 2) THEN
                 T=matrix_uxux_epemuxux(P ,NHEL(1,IHEL),JC(1))            
...
C                WRITE(*,*) ngood,IHEL,T
      ...
      REAL*8 FUNCTION matrix_uxux_epemuxux(P,NHEL,IC)
C  
C Generated by MadGraph II Version 3.90. Updated 08/26/05               
C RETURNS AMPLITUDE SQUARED SUMMED/AVG OVER COLORS
...
C ----------
      ...
      CALL IOVXXX(W(1,15  ),W(1,2   ),W(1,7   ),GZU ,AMP(6   ))            
      CALL JIOXXX(W(1,6   ),W(1,2   ),GG ,ZERO    ,ZERO    ,W(1,16  ))     
      CALL FVOXXX(W(1,1   ),W(1,7   ),GZU ,ZERO    ,ZERO    ,W(1,17  ))    
      ...
      matrix_uxux_epemuxux = 0.D0 
      DO I = 1, NCOLOR
          ZTEMP = (0.D0,0.D0)
          DO J = 1, NCOLOR
              ZTEMP = ZTEMP + CF(J,I)*JAMP(J)
          ENDDO
          matrix_uxux_epemuxux =matrix_uxux_epemuxux+ZTEMP*DCONJG(JAMP(I))/DENOM(I)   
      ENDDO
      Do I = 1, NGRAPHS
