      SUBROUTINE smatrix_uu_epmumvevmxuu(P1,ANS)
C  
...
C  
      ...
      common/to_amps_uu_epmumvevmxuu/  amp2,       jamp2
      ...
      common/to_matrix_uu_epmumvevmxuu/isum_hel, multi_channel
      INTEGER MAPCONFIG(0:LMAXCONFIGS), ICONFIG
      common/to_mconfigs_uu_epmumvevmxuu/mapconfig, iconfig
      DATA NTRY,IDUM /0,-1/
      integer iforest(2,-max_branch:-1,lmaxconfigs)
      common/to_forest_uu_epmumvevmxuu/ iforest
      include "configs.inc"
      ...
      IF (ISUM_HEL .EQ. 0 .OR. NTRY .LT. 10) THEN
          DO IHEL=1,NCOMB
              IF (GOODHEL(IHEL,IPROC) .OR. NTRY .LT. 2) THEN
                 T=matrix_uu_epmumvevmxuu(P ,NHEL(1,IHEL),JC(1))            
...
C                WRITE(*,*) ngood,IHEL,T
      ...
      REAL*8 FUNCTION matrix_uu_epmumvevmxuu(P,NHEL,IC)
C  
C Generated by MadGraph II Version 3.90. Updated 08/26/05               
C RETURNS AMPLITUDE SQUARED SUMMED/AVG OVER COLORS
...
C ----------
      ...
      CALL FVOXXX(W(1,7   ),W(1,10  ),GWF ,ZERO    ,ZERO    ,W(1,14  ))    
      CALL IOVXXX(W(1,12  ),W(1,14  ),W(1,11  ),GG ,AMP(2   ))             
      CALL JIOXXX(W(1,2   ),W(1,7   ),GG ,ZERO    ,ZERO    ,W(1,15  ))     
      CALL FVOXXX(W(1,8   ),W(1,10  ),GWF ,ZERO    ,ZERO    ,W(1,16  ))    
      CALL FVIXXX(W(1,1   ),W(1,9   ),GWF ,ZERO    ,ZERO    ,W(1,17  ))    
      CALL IOVXXX(W(1,17  ),W(1,16  ),W(1,15  ),GG ,AMP(3   ))             
      CALL FVOXXX(W(1,8   ),W(1,15  ),GG ,ZERO    ,ZERO    ,W(1,18  ))     
      CALL IOVXXX(W(1,17  ),W(1,18  ),W(1,10  ),GWF ,AMP(4   ))            
      CALL JVVXXX(W(1,10  ),W(1,9   ),GWWA ,ZERO    ,AWIDTH  ,W(1,         
     &     19  ))                                                          
      CALL FVOXXX(W(1,7   ),W(1,11  ),GG ,ZERO    ,ZERO    ,W(1,20  ))     
      CALL IOVXXX(W(1,2   ),W(1,20  ),W(1,19  ),GAU ,AMP(5   ))            
      CALL JVVXXX(W(1,10  ),W(1,9   ),GWWZ ,ZMASS   ,ZWIDTH  ,W(1,         
     &     21  ))                                                          
      CALL IOVXXX(W(1,2   ),W(1,20  ),W(1,21  ),GZU ,AMP(6   ))            
      CALL FVIXXX(W(1,1   ),W(1,15  ),GG ,ZERO    ,ZERO    ,W(1,22  ))     
      CALL IOVXXX(W(1,22  ),W(1,8   ),W(1,19  ),GAU ,AMP(7   ))            
      CALL IOVXXX(W(1,22  ),W(1,8   ),W(1,21  ),GZU ,AMP(8   ))            
      CALL IOVXXX(W(1,22  ),W(1,16  ),W(1,9   ),GWF ,AMP(9   ))            
      CALL JIOXXX(W(1,1   ),W(1,18  ),GAU ,ZERO    ,AWIDTH  ,W(1,23  ))    
      CALL VVVXXX(W(1,10  ),W(1,9   ),W(1,23  ),GWWA ,AMP(10  ))           
      CALL JIOXXX(W(1,1   ),W(1,18  ),GZU ,ZMASS   ,ZWIDTH  ,W(1,24  ))    
      CALL VVVXXX(W(1,10  ),W(1,9   ),W(1,24  ),GWWZ ,AMP(11  ))           
      CALL FVIXXX(W(1,2   ),W(1,11  ),GG ,ZERO    ,ZERO    ,W(1,25  ))     
      CALL IOVXXX(W(1,25  ),W(1,7   ),W(1,19  ),GAU ,AMP(12  ))            
      CALL IOVXXX(W(1,25  ),W(1,7   ),W(1,21  ),GZU ,AMP(13  ))            
      CALL IOVXXX(W(1,25  ),W(1,14  ),W(1,9   ),GWF ,AMP(14  ))            
      CALL JIOXXX(W(1,1   ),W(1,7   ),GG ,ZERO    ,ZERO    ,W(1,26  ))     
      CALL IOVXXX(W(1,12  ),W(1,16  ),W(1,26  ),GG ,AMP(15  ))             
      CALL FVOXXX(W(1,8   ),W(1,26  ),GG ,ZERO    ,ZERO    ,W(1,27  ))     
      CALL IOVXXX(W(1,12  ),W(1,27  ),W(1,10  ),GWF ,AMP(16  ))            
      CALL JIOXXX(W(1,2   ),W(1,8   ),GG ,ZERO    ,ZERO    ,W(1,28  ))     
      CALL FVIXXX(W(1,17  ),W(1,10  ),GWF ,ZERO    ,ZERO    ,W(1,29  ))    
      CALL IOVXXX(W(1,29  ),W(1,7   ),W(1,28  ),GG ,AMP(17  ))             
      CALL IOVXXX(W(1,17  ),W(1,14  ),W(1,28  ),GG ,AMP(18  ))             
      CALL FVIXXX(W(1,2   ),W(1,26  ),GG ,ZERO    ,ZERO    ,W(1,30  ))     
      CALL IOVXXX(W(1,30  ),W(1,8   ),W(1,19  ),GAU ,AMP(19  ))            
      CALL IOVXXX(W(1,30  ),W(1,8   ),W(1,21  ),GZU ,AMP(20  ))            
      CALL IOVXXX(W(1,30  ),W(1,16  ),W(1,9   ),GWF ,AMP(21  ))            
      CALL JIOXXX(W(1,2   ),W(1,27  ),GAU ,ZERO    ,AWIDTH  ,W(1,31  ))    
      CALL VVVXXX(W(1,10  ),W(1,9   ),W(1,31  ),GWWA ,AMP(22  ))           
      CALL JIOXXX(W(1,2   ),W(1,27  ),GZU ,ZMASS   ,ZWIDTH  ,W(1,32  ))    
      CALL VVVXXX(W(1,10  ),W(1,9   ),W(1,32  ),GWWZ ,AMP(23  ))           
      CALL FVOXXX(W(1,7   ),W(1,28  ),GG ,ZERO    ,ZERO    ,W(1,33  ))     
      CALL IOVXXX(W(1,1   ),W(1,33  ),W(1,19  ),GAU ,AMP(24  ))            
      CALL IOVXXX(W(1,1   ),W(1,33  ),W(1,21  ),GZU ,AMP(25  ))            
      CALL FVIXXX(W(1,1   ),W(1,28  ),GG ,ZERO    ,ZERO    ,W(1,34  ))     
      CALL IOVXXX(W(1,34  ),W(1,7   ),W(1,19  ),GAU ,AMP(26  ))            
      CALL IOVXXX(W(1,34  ),W(1,7   ),W(1,21  ),GZU ,AMP(27  ))            
      CALL IOVXXX(W(1,34  ),W(1,14  ),W(1,9   ),GWF ,AMP(28  ))            
     ...
     &             -AMP(  25)-AMP(  26)-AMP(  27)-AMP(  28)
      matrix_uu_epmumvevmxuu = 0.D0 
      DO I = 1, NCOLOR
          ZTEMP = (0.D0,0.D0)
          DO J = 1, NCOLOR
              ZTEMP = ZTEMP + CF(J,I)*JAMP(J)
          ENDDO
          matrix_uu_epmumvevmxuu =matrix_uu_epmumvevmxuu+ZTEMP*DCONJG(JAMP(I))/DENOM(I)   
      ENDDO
      Do I = 1, NGRAPHS
