      SUBROUTINE smatrix_dux_epmumvevmxscx(P1,ANS)
C  
...
C  
C FOR PROCESS : d u~ -> e+ mu- ve vm~ s c~  
C  
C Crossing   1 is d u~ -> e+ mu- ve vm~ s c~  
      IMPLICIT NONE
C  
C CONSTANTS
C  
...
C  
      ...
      REAL*8 matrix_dux_epmumvevmxscx
...
C  
      ...
      common/to_amps_dux_epmumvevmxscx/  amp2,       jamp2
      ...
      common/to_matrix_dux_epmumvevmxscx/isum_hel, multi_channel
      INTEGER MAPCONFIG(0:LMAXCONFIGS), ICONFIG
      common/to_mconfigs_dux_epmumvevmxscx/mapconfig, iconfig
      DATA NTRY,IDUM /0,-1/
      integer iforest(2,-max_branch:-1,lmaxconfigs)
      common/to_forest_dux_epmumvevmxscx/ iforest
      include "configs.inc"
      ...
      IF (ISUM_HEL .EQ. 0 .OR. NTRY .LT. 10) THEN
          DO IHEL=1,NCOMB
              IF (GOODHEL(IHEL,IPROC) .OR. NTRY .LT. 2) THEN
                 T=matrix_dux_epmumvevmxscx(P ,NHEL(1,IHEL),JC(1))            
...
C                WRITE(*,*) ngood,IHEL,T
      ...
      REAL*8 FUNCTION matrix_dux_epmumvevmxscx(P,NHEL,IC)
C  
C Generated by MadGraph II Version 3.90. Updated 08/26/05               
C RETURNS AMPLITUDE SQUARED SUMMED/AVG OVER COLORS
...
C ----------
      ...
      CALL IOVXXX(W(1,12  ),W(1,2   ),W(1,13  ),GG ,AMP(1   ))             
      ...
      CALL IOVXXX(W(1,1   ),W(1,17  ),W(1,13  ),GG ,AMP(3   ))             
      CALL FVIXXX(W(1,1   ),W(1,15  ),GG ,ZERO    ,ZERO    ,W(1,18  ))     
      CALL IOVXXX(W(1,18  ),W(1,2   ),W(1,10  ),GWF ,AMP(4   ))            
      JAMP(   1) = -AMP(   1)-AMP(   2)-AMP(   3)-AMP(   4)
      matrix_dux_epmumvevmxscx = 0.D0 
      DO I = 1, NCOLOR
          ZTEMP = (0.D0,0.D0)
          DO J = 1, NCOLOR
              ZTEMP = ZTEMP + CF(J,I)*JAMP(J)
          ENDDO
          matrix_dux_epmumvevmxscx =matrix_dux_epmumvevmxscx+ZTEMP*DCONJG(JAMP(I))/DENOM(I)   
      ENDDO
      Do I = 1, NGRAPHS
