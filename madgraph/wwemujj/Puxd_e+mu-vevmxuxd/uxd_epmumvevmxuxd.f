      SUBROUTINE smatrix_uxd_epmumvevmxuxd(P1,ANS)
C  
...
C  
C FOR PROCESS : u~ d -> e+ mu- ve vm~ u~ d  
C  
C Crossing   1 is u~ d -> e+ mu- ve vm~ u~ d  
      IMPLICIT NONE
C  
C CONSTANTS
C  
...
C  
      ...
      REAL*8 matrix_uxd_epmumvevmxuxd
...
C  
      ...
      common/to_amps_uxd_epmumvevmxuxd/  amp2,       jamp2
      ...
      common/to_matrix_uxd_epmumvevmxuxd/isum_hel, multi_channel
      INTEGER MAPCONFIG(0:LMAXCONFIGS), ICONFIG
      common/to_mconfigs_uxd_epmumvevmxuxd/mapconfig, iconfig
      DATA NTRY,IDUM /0,-1/
      integer iforest(2,-max_branch:-1,lmaxconfigs)
      common/to_forest_uxd_epmumvevmxuxd/ iforest
      include "configs.inc"
      ...
      IF (ISUM_HEL .EQ. 0 .OR. NTRY .LT. 10) THEN
          DO IHEL=1,NCOMB
              IF (GOODHEL(IHEL,IPROC) .OR. NTRY .LT. 2) THEN
                 T=matrix_uxd_epmumvevmxuxd(P ,NHEL(1,IHEL),JC(1))            
...
C                WRITE(*,*) ngood,IHEL,T
      ...
      REAL*8 FUNCTION matrix_uxd_epmumvevmxuxd(P,NHEL,IC)
C  
C Generated by MadGraph II Version 3.90. Updated 08/26/05               
C RETURNS AMPLITUDE SQUARED SUMMED/AVG OVER COLORS
...
C ----------
     ...
     &     23  ))                                                          
      ...
      CALL JIOXXX(W(1,7   ),W(1,17  ),GG ,ZERO    ,ZERO    ,W(1,27  ))     
      CALL IOVXXX(W(1,2   ),W(1,12  ),W(1,27  ),GG ,AMP(15  ))             
      CALL JIOXXX(W(1,14  ),W(1,8   ),GG ,ZERO    ,ZERO    ,W(1,28  ))     
      CALL FVIXXX(W(1,2   ),W(1,28  ),GG ,ZERO    ,ZERO    ,W(1,29  ))     
      CALL IOVXXX(W(1,29  ),W(1,1   ),W(1,10  ),GWF ,AMP(16  ))            
      CALL FVIXXX(W(1,2   ),W(1,10  ),GWF ,ZERO    ,ZERO    ,W(1,30  ))    
      CALL IOVXXX(W(1,30  ),W(1,1   ),W(1,27  ),GG ,AMP(17  ))             
      CALL FVOXXX(W(1,1   ),W(1,28  ),GG ,ZERO    ,ZERO    ,W(1,31  ))     
     ...
     &             +AMP(  11)+AMP(  12)+AMP(  13)+AMP(  14)
      ...
      matrix_uxd_epmumvevmxuxd = 0.D0 
      DO I = 1, NCOLOR
          ZTEMP = (0.D0,0.D0)
          DO J = 1, NCOLOR
              ZTEMP = ZTEMP + CF(J,I)*JAMP(J)
          ENDDO
          matrix_uxd_epmumvevmxuxd =matrix_uxd_epmumvevmxuxd+ZTEMP*DCONJG(JAMP(I))/DENOM(I)   
      ENDDO
      Do I = 1, NGRAPHS
