      SUBROUTINE smatrix_uux_epmumvevmxgg(P1,ANS)
C  
...
C  
C FOR PROCESS : u u~ -> e+ mu- ve vm~ g g  
C  
C Crossing   1 is u u~ -> e+ mu- ve vm~ g g  
      IMPLICIT NONE
C  
C CONSTANTS
C  
...
C  
      ...
      REAL*8 matrix_uux_epmumvevmxgg
...
C  
      ...
      common/to_amps_uux_epmumvevmxgg/  amp2,       jamp2
      ...
      common/to_matrix_uux_epmumvevmxgg/isum_hel, multi_channel
      INTEGER MAPCONFIG(0:LMAXCONFIGS), ICONFIG
      common/to_mconfigs_uux_epmumvevmxgg/mapconfig, iconfig
      DATA NTRY,IDUM /0,-1/
      integer iforest(2,-max_branch:-1,lmaxconfigs)
      common/to_forest_uux_epmumvevmxgg/ iforest
      include "configs.inc"
      ...
      IF (ISUM_HEL .EQ. 0 .OR. NTRY .LT. 10) THEN
          DO IHEL=1,NCOMB
              IF (GOODHEL(IHEL,IPROC) .OR. NTRY .LT. 2) THEN
                 T=matrix_uux_epmumvevmxgg(P ,NHEL(1,IHEL),JC(1))            
...
C                WRITE(*,*) ngood,IHEL,T
      ...
      REAL*8 FUNCTION matrix_uux_epmumvevmxgg(P,NHEL,IC)
C  
C Generated by MadGraph II Version 3.90. Updated 08/26/05               
C RETURNS AMPLITUDE SQUARED SUMMED/AVG OVER COLORS
...
C  
      ...
      PARAMETER (NGRAPHS=  31,NEIGEN=  2) 
      include "genps.inc"
      INTEGER    NWAVEFUNCS     , NCOLOR
      PARAMETER (NWAVEFUNCS=  41, NCOLOR=   2) 
      REAL*8     ZERO
      PARAMETER (ZERO=0D0)
C  
C ARGUMENTS 
...
C ----------
      ...
      CALL FVOXXX(W(1,2   ),W(1,10  ),GWF ,ZERO    ,ZERO    ,W(1,12  ))    
      CALL FVIXXX(W(1,11  ),W(1,7   ),GG ,ZERO    ,ZERO    ,W(1,13  ))     
      CALL IOVXXX(W(1,13  ),W(1,12  ),W(1,9   ),GWF ,AMP(1   ))            
      ...
      CALL IOVXXX(W(1,16  ),W(1,15  ),W(1,10  ),GWF ,AMP(2   ))            
      CALL JVVXXX(W(1,8   ),W(1,7   ),G ,ZERO    ,ZERO    ,W(1,17  ))      
      CALL FVIXXX(W(1,1   ),W(1,17  ),GG ,ZERO    ,ZERO    ,W(1,18  ))     
      CALL IOVXXX(W(1,18  ),W(1,12  ),W(1,9   ),GWF ,AMP(3   ))            
      CALL IOVXXX(W(1,16  ),W(1,12  ),W(1,8   ),GG ,AMP(4   ))             
      CALL FVIXXX(W(1,14  ),W(1,8   ),GG ,ZERO    ,ZERO    ,W(1,19  ))     
      CALL FVIXXX(W(1,19  ),W(1,9   ),GWF ,ZERO    ,ZERO    ,W(1,20  ))    
      CALL IOVXXX(W(1,20  ),W(1,2   ),W(1,10  ),GWF ,AMP(5   ))            
      CALL FVOXXX(W(1,2   ),W(1,7   ),GG ,ZERO    ,ZERO    ,W(1,21  ))     
      CALL FVIXXX(W(1,11  ),W(1,9   ),GWF ,ZERO    ,ZERO    ,W(1,22  ))    
      CALL IOVXXX(W(1,22  ),W(1,21  ),W(1,10  ),GWF ,AMP(6   ))            
      CALL FVIXXX(W(1,1   ),W(1,9   ),GWF ,ZERO    ,ZERO    ,W(1,23  ))    
      CALL FVIXXX(W(1,23  ),W(1,10  ),GWF ,ZERO    ,ZERO    ,W(1,24  ))    
      CALL IOVXXX(W(1,24  ),W(1,15  ),W(1,7   ),GG ,AMP(7   ))             
      CALL IOVXXX(W(1,24  ),W(1,2   ),W(1,17  ),GG ,AMP(8   ))             
      CALL FVOXXX(W(1,21  ),W(1,10  ),GWF ,ZERO    ,ZERO    ,W(1,25  ))    
      CALL IOVXXX(W(1,23  ),W(1,25  ),W(1,8   ),GG ,AMP(9   ))             
      CALL FVOXXX(W(1,21  ),W(1,8   ),GG ,ZERO    ,ZERO    ,W(1,26  ))     
      CALL IOVXXX(W(1,23  ),W(1,26  ),W(1,10  ),GWF ,AMP(10  ))            
      CALL IOVXXX(W(1,22  ),W(1,12  ),W(1,7   ),GG ,AMP(11  ))             
      CALL FVOXXX(W(1,15  ),W(1,10  ),GWF ,ZERO    ,ZERO    ,W(1,27  ))    
      CALL IOVXXX(W(1,23  ),W(1,27  ),W(1,7   ),GG ,AMP(12  ))             
      CALL IOVXXX(W(1,23  ),W(1,12  ),W(1,17  ),GG ,AMP(13  ))             
      CALL FVIXXX(W(1,23  ),W(1,7   ),GG ,ZERO    ,ZERO    ,W(1,28  ))     
      CALL IOVXXX(W(1,28  ),W(1,12  ),W(1,8   ),GG ,AMP(14  ))             
      CALL FVOXXX(W(1,12  ),W(1,7   ),GG ,ZERO    ,ZERO    ,W(1,29  ))     
      CALL IOVXXX(W(1,23  ),W(1,29  ),W(1,8   ),GG ,AMP(15  ))             
      CALL JVVXXX(W(1,10  ),W(1,9   ),GWWA ,ZERO    ,AWIDTH  ,W(1,         
     &     30  ))                                                          
      CALL IOVXXX(W(1,13  ),W(1,2   ),W(1,30  ),GAU ,AMP(16  ))            
      CALL JVVXXX(W(1,10  ),W(1,9   ),GWWZ ,ZMASS   ,ZWIDTH  ,W(1,         
     &     31  ))                                                          
      CALL IOVXXX(W(1,13  ),W(1,2   ),W(1,31  ),GZU ,AMP(17  ))            
      CALL JIOXXX(W(1,14  ),W(1,15  ),GAU ,ZERO    ,AWIDTH  ,W(1,32  ))    
      CALL VVVXXX(W(1,10  ),W(1,9   ),W(1,32  ),GWWA ,AMP(18  ))           
      CALL JIOXXX(W(1,14  ),W(1,15  ),GZU ,ZMASS   ,ZWIDTH  ,W(1,33  ))    
      CALL VVVXXX(W(1,10  ),W(1,9   ),W(1,33  ),GWWZ ,AMP(19  ))           
      CALL IOVXXX(W(1,18  ),W(1,2   ),W(1,30  ),GAU ,AMP(20  ))            
      CALL IOVXXX(W(1,18  ),W(1,2   ),W(1,31  ),GZU ,AMP(21  ))            
      CALL JIOXXX(W(1,19  ),W(1,2   ),GAU ,ZERO    ,AWIDTH  ,W(1,34  ))    
      CALL VVVXXX(W(1,10  ),W(1,9   ),W(1,34  ),GWWA ,AMP(22  ))           
      CALL JIOXXX(W(1,19  ),W(1,2   ),GZU ,ZMASS   ,ZWIDTH  ,W(1,35  ))    
      CALL VVVXXX(W(1,10  ),W(1,9   ),W(1,35  ),GWWZ ,AMP(23  ))           
      CALL JIOXXX(W(1,11  ),W(1,21  ),GAU ,ZERO    ,AWIDTH  ,W(1,36  ))    
      CALL VVVXXX(W(1,10  ),W(1,9   ),W(1,36  ),GWWA ,AMP(24  ))           
      CALL JIOXXX(W(1,11  ),W(1,21  ),GZU ,ZMASS   ,ZWIDTH  ,W(1,37  ))    
      CALL VVVXXX(W(1,10  ),W(1,9   ),W(1,37  ),GWWZ ,AMP(25  ))           
      CALL FVOXXX(W(1,15  ),W(1,7   ),GG ,ZERO    ,ZERO    ,W(1,38  ))     
      CALL IOVXXX(W(1,1   ),W(1,38  ),W(1,30  ),GAU ,AMP(26  ))            
      CALL IOVXXX(W(1,1   ),W(1,38  ),W(1,31  ),GZU ,AMP(27  ))            
      CALL FVOXXX(W(1,2   ),W(1,17  ),GG ,ZERO    ,ZERO    ,W(1,39  ))     
      CALL IOVXXX(W(1,1   ),W(1,39  ),W(1,30  ),GAU ,AMP(28  ))            
      CALL IOVXXX(W(1,1   ),W(1,39  ),W(1,31  ),GZU ,AMP(29  ))            
      CALL JIOXXX(W(1,1   ),W(1,26  ),GAU ,ZERO    ,AWIDTH  ,W(1,40  ))    
      CALL VVVXXX(W(1,10  ),W(1,9   ),W(1,40  ),GWWA ,AMP(30  ))           
      CALL JIOXXX(W(1,1   ),W(1,26  ),GZU ,ZMASS   ,ZWIDTH  ,W(1,41  ))    
      CALL VVVXXX(W(1,10  ),W(1,9   ),W(1,41  ),GWWZ ,AMP(31  ))           
      JAMP(   1) = +AMP(   1)-AMP(   3)+AMP(   6)-AMP(   8)+AMP(   9)
     &             +AMP(  10)+AMP(  11)-AMP(  13)+AMP(  15)+AMP(  16)
     &             +AMP(  17)-AMP(  20)-AMP(  21)+AMP(  24)+AMP(  25)
     &             -AMP(  28)-AMP(  29)+AMP(  30)+AMP(  31)
      JAMP(   2) = +AMP(   2)+AMP(   3)+AMP(   4)+AMP(   5)+AMP(   7)
     &             +AMP(   8)+AMP(  12)+AMP(  13)+AMP(  14)+AMP(  18)
     &             +AMP(  19)+AMP(  20)+AMP(  21)+AMP(  22)+AMP(  23)
     &             +AMP(  26)+AMP(  27)+AMP(  28)+AMP(  29)
      matrix_uux_epmumvevmxgg = 0.D0 
      DO I = 1, NCOLOR
          ZTEMP = (0.D0,0.D0)
          DO J = 1, NCOLOR
              ZTEMP = ZTEMP + CF(J,I)*JAMP(J)
          ENDDO
          matrix_uux_epmumvevmxgg =matrix_uux_epmumvevmxgg+ZTEMP*DCONJG(JAMP(I))/DENOM(I)   
      ENDDO
      Do I = 1, NGRAPHS
