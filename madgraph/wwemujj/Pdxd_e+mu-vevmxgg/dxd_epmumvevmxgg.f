      SUBROUTINE smatrix_dxd_epmumvevmxgg(P1,ANS)
C  
...
C  
C FOR PROCESS : d~ d -> e+ mu- ve vm~ g g  
C  
C Crossing   1 is d~ d -> e+ mu- ve vm~ g g  
      IMPLICIT NONE
C  
C CONSTANTS
C  
...
C  
      ...
      REAL*8 matrix_dxd_epmumvevmxgg
...
C  
      ...
      common/to_amps_dxd_epmumvevmxgg/  amp2,       jamp2
      ...
      common/to_matrix_dxd_epmumvevmxgg/isum_hel, multi_channel
      INTEGER MAPCONFIG(0:LMAXCONFIGS), ICONFIG
      common/to_mconfigs_dxd_epmumvevmxgg/mapconfig, iconfig
      DATA NTRY,IDUM /0,-1/
      integer iforest(2,-max_branch:-1,lmaxconfigs)
      common/to_forest_dxd_epmumvevmxgg/ iforest
      include "configs.inc"
      ...
      IF (ISUM_HEL .EQ. 0 .OR. NTRY .LT. 10) THEN
          DO IHEL=1,NCOMB
              IF (GOODHEL(IHEL,IPROC) .OR. NTRY .LT. 2) THEN
                 T=matrix_dxd_epmumvevmxgg(P ,NHEL(1,IHEL),JC(1))            
...
C                WRITE(*,*) ngood,IHEL,T
      ...
      REAL*8 FUNCTION matrix_dxd_epmumvevmxgg(P,NHEL,IC)
C  
C Generated by MadGraph II Version 3.90. Updated 08/26/05               
C RETURNS AMPLITUDE SQUARED SUMMED/AVG OVER COLORS
...
C ----------
      ...
      CALL FVIXXX(W(1,2   ),W(1,10  ),GWF ,ZERO    ,ZERO    ,W(1,12  ))    
      CALL FVOXXX(W(1,11  ),W(1,7   ),GG ,ZERO    ,ZERO    ,W(1,13  ))     
      CALL IOVXXX(W(1,12  ),W(1,13  ),W(1,9   ),GWF ,AMP(1   ))            
      ...
      CALL IOVXXX(W(1,15  ),W(1,16  ),W(1,10  ),GWF ,AMP(2   ))            
      CALL JVVXXX(W(1,8   ),W(1,7   ),G ,ZERO    ,ZERO    ,W(1,17  ))      
      CALL FVOXXX(W(1,1   ),W(1,17  ),GG ,ZERO    ,ZERO    ,W(1,18  ))     
      CALL IOVXXX(W(1,12  ),W(1,18  ),W(1,9   ),GWF ,AMP(3   ))            
      CALL IOVXXX(W(1,12  ),W(1,16  ),W(1,8   ),GG ,AMP(4   ))             
      CALL FVOXXX(W(1,14  ),W(1,8   ),GG ,ZERO    ,ZERO    ,W(1,19  ))     
      CALL FVOXXX(W(1,19  ),W(1,9   ),GWF ,ZERO    ,ZERO    ,W(1,20  ))    
      CALL IOVXXX(W(1,2   ),W(1,20  ),W(1,10  ),GWF ,AMP(5   ))            
      CALL FVIXXX(W(1,2   ),W(1,7   ),GG ,ZERO    ,ZERO    ,W(1,21  ))     
      CALL FVOXXX(W(1,11  ),W(1,9   ),GWF ,ZERO    ,ZERO    ,W(1,22  ))    
      CALL IOVXXX(W(1,21  ),W(1,22  ),W(1,10  ),GWF ,AMP(6   ))            
      CALL FVOXXX(W(1,1   ),W(1,9   ),GWF ,ZERO    ,ZERO    ,W(1,23  ))    
      CALL FVOXXX(W(1,23  ),W(1,10  ),GWF ,ZERO    ,ZERO    ,W(1,24  ))    
      CALL IOVXXX(W(1,15  ),W(1,24  ),W(1,7   ),GG ,AMP(7   ))             
      CALL IOVXXX(W(1,2   ),W(1,24  ),W(1,17  ),GG ,AMP(8   ))             
      CALL FVIXXX(W(1,21  ),W(1,10  ),GWF ,ZERO    ,ZERO    ,W(1,25  ))    
      CALL IOVXXX(W(1,25  ),W(1,23  ),W(1,8   ),GG ,AMP(9   ))             
      CALL FVIXXX(W(1,21  ),W(1,8   ),GG ,ZERO    ,ZERO    ,W(1,26  ))     
      CALL IOVXXX(W(1,26  ),W(1,23  ),W(1,10  ),GWF ,AMP(10  ))            
      CALL IOVXXX(W(1,12  ),W(1,22  ),W(1,7   ),GG ,AMP(11  ))             
      CALL FVIXXX(W(1,15  ),W(1,10  ),GWF ,ZERO    ,ZERO    ,W(1,27  ))    
      CALL IOVXXX(W(1,27  ),W(1,23  ),W(1,7   ),GG ,AMP(12  ))             
      CALL IOVXXX(W(1,12  ),W(1,23  ),W(1,17  ),GG ,AMP(13  ))             
      CALL FVOXXX(W(1,23  ),W(1,7   ),GG ,ZERO    ,ZERO    ,W(1,28  ))     
      CALL IOVXXX(W(1,12  ),W(1,28  ),W(1,8   ),GG ,AMP(14  ))             
      CALL FVIXXX(W(1,12  ),W(1,7   ),GG ,ZERO    ,ZERO    ,W(1,29  ))     
      CALL IOVXXX(W(1,29  ),W(1,23  ),W(1,8   ),GG ,AMP(15  ))             
      CALL JVVXXX(W(1,10  ),W(1,9   ),GWWA ,ZERO    ,AWIDTH  ,W(1,         
     &     30  ))                                                          
      CALL IOVXXX(W(1,2   ),W(1,13  ),W(1,30  ),GAD ,AMP(16  ))            
      CALL JVVXXX(W(1,10  ),W(1,9   ),GWWZ ,ZMASS   ,ZWIDTH  ,W(1,         
     &     31  ))                                                          
      CALL IOVXXX(W(1,2   ),W(1,13  ),W(1,31  ),GZD ,AMP(17  ))            
      CALL JIOXXX(W(1,15  ),W(1,14  ),GAD ,ZERO    ,AWIDTH  ,W(1,32  ))    
      CALL VVVXXX(W(1,10  ),W(1,9   ),W(1,32  ),GWWA ,AMP(18  ))           
      CALL JIOXXX(W(1,15  ),W(1,14  ),GZD ,ZMASS   ,ZWIDTH  ,W(1,33  ))    
      CALL VVVXXX(W(1,10  ),W(1,9   ),W(1,33  ),GWWZ ,AMP(19  ))           
      CALL IOVXXX(W(1,2   ),W(1,18  ),W(1,30  ),GAD ,AMP(20  ))            
      CALL IOVXXX(W(1,2   ),W(1,18  ),W(1,31  ),GZD ,AMP(21  ))            
      CALL JIOXXX(W(1,2   ),W(1,19  ),GAD ,ZERO    ,AWIDTH  ,W(1,34  ))    
      CALL VVVXXX(W(1,10  ),W(1,9   ),W(1,34  ),GWWA ,AMP(22  ))           
      CALL JIOXXX(W(1,2   ),W(1,19  ),GZD ,ZMASS   ,ZWIDTH  ,W(1,35  ))    
      CALL VVVXXX(W(1,10  ),W(1,9   ),W(1,35  ),GWWZ ,AMP(23  ))           
      CALL JIOXXX(W(1,21  ),W(1,11  ),GAD ,ZERO    ,AWIDTH  ,W(1,36  ))    
      CALL VVVXXX(W(1,10  ),W(1,9   ),W(1,36  ),GWWA ,AMP(24  ))           
      CALL JIOXXX(W(1,21  ),W(1,11  ),GZD ,ZMASS   ,ZWIDTH  ,W(1,37  ))    
      CALL VVVXXX(W(1,10  ),W(1,9   ),W(1,37  ),GWWZ ,AMP(25  ))           
      CALL FVIXXX(W(1,15  ),W(1,7   ),GG ,ZERO    ,ZERO    ,W(1,38  ))     
      CALL IOVXXX(W(1,38  ),W(1,1   ),W(1,30  ),GAD ,AMP(26  ))            
      CALL IOVXXX(W(1,38  ),W(1,1   ),W(1,31  ),GZD ,AMP(27  ))            
      CALL FVIXXX(W(1,2   ),W(1,17  ),GG ,ZERO    ,ZERO    ,W(1,39  ))     
      CALL IOVXXX(W(1,39  ),W(1,1   ),W(1,30  ),GAD ,AMP(28  ))            
      CALL IOVXXX(W(1,39  ),W(1,1   ),W(1,31  ),GZD ,AMP(29  ))            
      CALL JIOXXX(W(1,26  ),W(1,1   ),GAD ,ZERO    ,AWIDTH  ,W(1,40  ))    
      CALL VVVXXX(W(1,10  ),W(1,9   ),W(1,40  ),GWWA ,AMP(30  ))           
      CALL JIOXXX(W(1,26  ),W(1,1   ),GZD ,ZMASS   ,ZWIDTH  ,W(1,41  ))    
     ...
     &             -AMP(  26)-AMP(  27)+AMP(  28)+AMP(  29)
      matrix_dxd_epmumvevmxgg = 0.D0 
      DO I = 1, NCOLOR
          ZTEMP = (0.D0,0.D0)
          DO J = 1, NCOLOR
              ZTEMP = ZTEMP + CF(J,I)*JAMP(J)
          ENDDO
          matrix_dxd_epmumvevmxgg =matrix_dxd_epmumvevmxgg+ZTEMP*DCONJG(JAMP(I))/DENOM(I)   
      ENDDO
      Do I = 1, NGRAPHS
