      SUBROUTINE smatrix_gdx_epmumvevmxdxg(P1,ANS)
C  
...
C  
      ...
      REAL*8 matrix_gdx_epmumvevmxdxg
...
C  
      ...
      common/to_amps_gdx_epmumvevmxdxg/  amp2,       jamp2
      ...
      common/to_matrix_gdx_epmumvevmxdxg/isum_hel, multi_channel
      INTEGER MAPCONFIG(0:LMAXCONFIGS), ICONFIG
      common/to_mconfigs_gdx_epmumvevmxdxg/mapconfig, iconfig
      DATA NTRY,IDUM /0,-1/
      integer iforest(2,-max_branch:-1,lmaxconfigs)
      common/to_forest_gdx_epmumvevmxdxg/ iforest
      include "configs.inc"
      ...
      IF (ISUM_HEL .EQ. 0 .OR. NTRY .LT. 10) THEN
          DO IHEL=1,NCOMB
              IF (GOODHEL(IHEL,IPROC) .OR. NTRY .LT. 2) THEN
                 T=matrix_gdx_epmumvevmxdxg(P ,NHEL(1,IHEL),JC(1))            
...
C                WRITE(*,*) ngood,IHEL,T
      ...
      REAL*8 FUNCTION matrix_gdx_epmumvevmxdxg(P,NHEL,IC)
C  
C Generated by MadGraph II Version 3.90. Updated 08/26/05               
C RETURNS AMPLITUDE SQUARED SUMMED/AVG OVER COLORS
...
C ----------
      ...
      CALL IOVXXX(W(1,7   ),W(1,13  ),W(1,11  ),GG ,AMP(1   ))             
      ...
      CALL IOVXXX(W(1,17  ),W(1,13  ),W(1,1   ),GG ,AMP(3   ))             
      ...
      CALL IOVXXX(W(1,20  ),W(1,12  ),W(1,11  ),GG ,AMP(6   ))             
      CALL IOVXXX(W(1,20  ),W(1,16  ),W(1,1   ),GG ,AMP(7   ))             
      CALL FVOXXX(W(1,12  ),W(1,1   ),GG ,ZERO    ,ZERO    ,W(1,21  ))     
      CALL IOVXXX(W(1,17  ),W(1,21  ),W(1,10  ),GWF ,AMP(8   ))            
      CALL FVIXXX(W(1,20  ),W(1,1   ),GG ,ZERO    ,ZERO    ,W(1,22  ))     
      CALL IOVXXX(W(1,22  ),W(1,12  ),W(1,8   ),GG ,AMP(9   ))             
      CALL FVIXXX(W(1,20  ),W(1,8   ),GG ,ZERO    ,ZERO    ,W(1,23  ))     
      CALL IOVXXX(W(1,23  ),W(1,12  ),W(1,1   ),GG ,AMP(10  ))             
      CALL JVVXXX(W(1,10  ),W(1,9   ),GWWA ,ZERO    ,AWIDTH  ,W(1,         
     &     24  ))                                                          
      CALL FVIXXX(W(1,7   ),W(1,11  ),GG ,ZERO    ,ZERO    ,W(1,25  ))     
      CALL IOVXXX(W(1,25  ),W(1,2   ),W(1,24  ),GAD ,AMP(11  ))            
      CALL JVVXXX(W(1,10  ),W(1,9   ),GWWZ ,ZMASS   ,ZWIDTH  ,W(1,         
     &     26  ))                                                          
      CALL IOVXXX(W(1,25  ),W(1,2   ),W(1,26  ),GZD ,AMP(12  ))            
      CALL JIOXXX(W(1,14  ),W(1,15  ),GAD ,ZERO    ,AWIDTH  ,W(1,27  ))    
      CALL VVVXXX(W(1,10  ),W(1,9   ),W(1,27  ),GWWA ,AMP(13  ))           
      CALL JIOXXX(W(1,14  ),W(1,15  ),GZD ,ZMASS   ,ZWIDTH  ,W(1,28  ))    
      CALL VVVXXX(W(1,10  ),W(1,9   ),W(1,28  ),GWWZ ,AMP(14  ))           
      CALL FVIXXX(W(1,17  ),W(1,1   ),GG ,ZERO    ,ZERO    ,W(1,29  ))     
      CALL IOVXXX(W(1,29  ),W(1,2   ),W(1,24  ),GAD ,AMP(15  ))            
      CALL IOVXXX(W(1,29  ),W(1,2   ),W(1,26  ),GZD ,AMP(16  ))            
      CALL JIOXXX(W(1,19  ),W(1,2   ),GAD ,ZERO    ,AWIDTH  ,W(1,30  ))    
      CALL VVVXXX(W(1,10  ),W(1,9   ),W(1,30  ),GWWA ,AMP(17  ))           
      CALL JIOXXX(W(1,19  ),W(1,2   ),GZD ,ZMASS   ,ZWIDTH  ,W(1,31  ))    
      CALL VVVXXX(W(1,10  ),W(1,9   ),W(1,31  ),GWWZ ,AMP(18  ))           
      CALL FVOXXX(W(1,2   ),W(1,11  ),GG ,ZERO    ,ZERO    ,W(1,32  ))     
      CALL IOVXXX(W(1,7   ),W(1,32  ),W(1,24  ),GAD ,AMP(19  ))            
      CALL IOVXXX(W(1,7   ),W(1,32  ),W(1,26  ),GZD ,AMP(20  ))            
      CALL FVOXXX(W(1,15  ),W(1,1   ),GG ,ZERO    ,ZERO    ,W(1,33  ))     
      CALL IOVXXX(W(1,7   ),W(1,33  ),W(1,24  ),GAD ,AMP(21  ))            
      CALL IOVXXX(W(1,7   ),W(1,33  ),W(1,26  ),GZD ,AMP(22  ))            
      CALL FVOXXX(W(1,2   ),W(1,1   ),GG ,ZERO    ,ZERO    ,W(1,34  ))     
      CALL IOVXXX(W(1,17  ),W(1,34  ),W(1,24  ),GAD ,AMP(23  ))            
      CALL IOVXXX(W(1,17  ),W(1,34  ),W(1,26  ),GZD ,AMP(24  ))            
      CALL FVOXXX(W(1,34  ),W(1,8   ),GG ,ZERO    ,ZERO    ,W(1,35  ))     
      CALL IOVXXX(W(1,7   ),W(1,35  ),W(1,24  ),GAD ,AMP(25  ))            
      CALL IOVXXX(W(1,7   ),W(1,35  ),W(1,26  ),GZD ,AMP(26  ))            
     ...
     &             -AMP(  21)-AMP(  22)-AMP(  27)-AMP(  28)
      matrix_gdx_epmumvevmxdxg = 0.D0 
      DO I = 1, NCOLOR
          ZTEMP = (0.D0,0.D0)
          DO J = 1, NCOLOR
              ZTEMP = ZTEMP + CF(J,I)*JAMP(J)
          ENDDO
          matrix_gdx_epmumvevmxdxg =matrix_gdx_epmumvevmxdxg+ZTEMP*DCONJG(JAMP(I))/DENOM(I)   
      ENDDO
      Do I = 1, NGRAPHS
