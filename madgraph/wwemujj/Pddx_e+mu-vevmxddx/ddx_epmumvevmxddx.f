      SUBROUTINE smatrix_ddx_epmumvevmxddx(P1,ANS)
C  
...
C  
      ...
      REAL*8 matrix_ddx_epmumvevmxddx
...
C  
      ...
      common/to_amps_ddx_epmumvevmxddx/  amp2,       jamp2
      ...
      common/to_matrix_ddx_epmumvevmxddx/isum_hel, multi_channel
      INTEGER MAPCONFIG(0:LMAXCONFIGS), ICONFIG
      common/to_mconfigs_ddx_epmumvevmxddx/mapconfig, iconfig
      DATA NTRY,IDUM /0,-1/
      integer iforest(2,-max_branch:-1,lmaxconfigs)
      common/to_forest_ddx_epmumvevmxddx/ iforest
      include "configs.inc"
      ...
      IF (ISUM_HEL .EQ. 0 .OR. NTRY .LT. 10) THEN
          DO IHEL=1,NCOMB
              IF (GOODHEL(IHEL,IPROC) .OR. NTRY .LT. 2) THEN
                 T=matrix_ddx_epmumvevmxddx(P ,NHEL(1,IHEL),JC(1))            
...
C                WRITE(*,*) ngood,IHEL,T
      ...
      REAL*8 FUNCTION matrix_ddx_epmumvevmxddx(P,NHEL,IC)
C  
C Generated by MadGraph II Version 3.90. Updated 08/26/05               
C RETURNS AMPLITUDE SQUARED SUMMED/AVG OVER COLORS
...
C ----------
     ...
     &     18  ))                                                          
      ...
      CALL IOVXXX(W(1,23  ),W(1,12  ),W(1,26  ),GG ,AMP(15  ))             
      ...
      CALL FVOXXX(W(1,7   ),W(1,28  ),GG ,ZERO    ,ZERO    ,W(1,29  ))     
      CALL IOVXXX(W(1,14  ),W(1,29  ),W(1,9   ),GWF ,AMP(17  ))            
      CALL FVOXXX(W(1,25  ),W(1,28  ),GG ,ZERO    ,ZERO    ,W(1,30  ))     
      CALL IOVXXX(W(1,1   ),W(1,30  ),W(1,10  ),GWF ,AMP(18  ))            
      CALL FVOXXX(W(1,2   ),W(1,26  ),GG ,ZERO    ,ZERO    ,W(1,31  ))     
      CALL IOVXXX(W(1,8   ),W(1,31  ),W(1,16  ),GAD ,AMP(19  ))            
      CALL IOVXXX(W(1,8   ),W(1,31  ),W(1,18  ),GZD ,AMP(20  ))            
      CALL IOVXXX(W(1,23  ),W(1,31  ),W(1,9   ),GWF ,AMP(21  ))            
      CALL JIOXXX(W(1,27  ),W(1,2   ),GAD ,ZERO    ,AWIDTH  ,W(1,32  ))    
      CALL VVVXXX(W(1,10  ),W(1,9   ),W(1,32  ),GWWA ,AMP(22  ))           
      CALL JIOXXX(W(1,27  ),W(1,2   ),GZD ,ZMASS   ,ZWIDTH  ,W(1,33  ))    
      CALL VVVXXX(W(1,10  ),W(1,9   ),W(1,33  ),GWWZ ,AMP(23  ))           
      CALL IOVXXX(W(1,1   ),W(1,29  ),W(1,16  ),GAD ,AMP(24  ))            
      CALL IOVXXX(W(1,1   ),W(1,29  ),W(1,18  ),GZD ,AMP(25  ))            
      CALL FVIXXX(W(1,1   ),W(1,28  ),GG ,ZERO    ,ZERO    ,W(1,34  ))     
      CALL IOVXXX(W(1,34  ),W(1,7   ),W(1,16  ),GAD ,AMP(26  ))            
      CALL IOVXXX(W(1,34  ),W(1,7   ),W(1,18  ),GZD ,AMP(27  ))            
      CALL IOVXXX(W(1,34  ),W(1,25  ),W(1,10  ),GWF ,AMP(28  ))            
     ...
     &             +AMP(  25)+AMP(  26)+AMP(  27)+AMP(  28)
      matrix_ddx_epmumvevmxddx = 0.D0 
      DO I = 1, NCOLOR
          ZTEMP = (0.D0,0.D0)
          DO J = 1, NCOLOR
              ZTEMP = ZTEMP + CF(J,I)*JAMP(J)
          ENDDO
          matrix_ddx_epmumvevmxddx =matrix_ddx_epmumvevmxddx+ZTEMP*DCONJG(JAMP(I))/DENOM(I)   
      ENDDO
      Do I = 1, NGRAPHS
