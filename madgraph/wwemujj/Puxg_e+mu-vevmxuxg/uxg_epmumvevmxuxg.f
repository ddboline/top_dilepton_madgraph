      SUBROUTINE smatrix_uxg_epmumvevmxuxg(P1,ANS)
C  
...
C  
      ...
      REAL*8 matrix_uxg_epmumvevmxuxg
...
C  
      ...
      common/to_amps_uxg_epmumvevmxuxg/  amp2,       jamp2
      ...
      common/to_matrix_uxg_epmumvevmxuxg/isum_hel, multi_channel
      INTEGER MAPCONFIG(0:LMAXCONFIGS), ICONFIG
      common/to_mconfigs_uxg_epmumvevmxuxg/mapconfig, iconfig
      DATA NTRY,IDUM /0,-1/
      integer iforest(2,-max_branch:-1,lmaxconfigs)
      common/to_forest_uxg_epmumvevmxuxg/ iforest
      include "configs.inc"
      ...
      IF (ISUM_HEL .EQ. 0 .OR. NTRY .LT. 10) THEN
          DO IHEL=1,NCOMB
              IF (GOODHEL(IHEL,IPROC) .OR. NTRY .LT. 2) THEN
                 T=matrix_uxg_epmumvevmxuxg(P ,NHEL(1,IHEL),JC(1))            
...
C                WRITE(*,*) ngood,IHEL,T
      ...
      REAL*8 FUNCTION matrix_uxg_epmumvevmxuxg(P,NHEL,IC)
C  
C Generated by MadGraph II Version 3.90. Updated 08/26/05               
C RETURNS AMPLITUDE SQUARED SUMMED/AVG OVER COLORS
...
C ----------
      ...
      CALL FVIXXX(W(1,11  ),W(1,9   ),GWF ,ZERO    ,ZERO    ,W(1,13  ))    
      CALL IOVXXX(W(1,13  ),W(1,12  ),W(1,10  ),GWF ,AMP(1   ))            
      CALL JVVXXX(W(1,8   ),W(1,2   ),G ,ZERO    ,ZERO    ,W(1,14  ))      
      CALL FVOXXX(W(1,1   ),W(1,10  ),GWF ,ZERO    ,ZERO    ,W(1,15  ))    
      CALL FVIXXX(W(1,7   ),W(1,14  ),GG ,ZERO    ,ZERO    ,W(1,16  ))     
      CALL IOVXXX(W(1,16  ),W(1,15  ),W(1,9   ),GWF ,AMP(2   ))            
      CALL FVIXXX(W(1,7   ),W(1,8   ),GG ,ZERO    ,ZERO    ,W(1,17  ))     
      CALL FVIXXX(W(1,17  ),W(1,2   ),GG ,ZERO    ,ZERO    ,W(1,18  ))     
      CALL IOVXXX(W(1,18  ),W(1,15  ),W(1,9   ),GWF ,AMP(3   ))            
      CALL IOVXXX(W(1,13  ),W(1,15  ),W(1,8   ),GG ,AMP(4   ))             
      CALL FVIXXX(W(1,11  ),W(1,8   ),GG ,ZERO    ,ZERO    ,W(1,19  ))     
      CALL FVIXXX(W(1,19  ),W(1,9   ),GWF ,ZERO    ,ZERO    ,W(1,20  ))    
      CALL IOVXXX(W(1,20  ),W(1,1   ),W(1,10  ),GWF ,AMP(5   ))            
      CALL FVIXXX(W(1,7   ),W(1,9   ),GWF ,ZERO    ,ZERO    ,W(1,21  ))    
      CALL FVIXXX(W(1,21  ),W(1,2   ),GG ,ZERO    ,ZERO    ,W(1,22  ))     
      CALL IOVXXX(W(1,22  ),W(1,12  ),W(1,10  ),GWF ,AMP(6   ))            
      CALL FVIXXX(W(1,21  ),W(1,14  ),GG ,ZERO    ,ZERO    ,W(1,23  ))     
      CALL IOVXXX(W(1,23  ),W(1,1   ),W(1,10  ),GWF ,AMP(7   ))            
      CALL FVIXXX(W(1,17  ),W(1,9   ),GWF ,ZERO    ,ZERO    ,W(1,24  ))    
      CALL IOVXXX(W(1,24  ),W(1,15  ),W(1,2   ),GG ,AMP(8   ))             
      CALL IOVXXX(W(1,22  ),W(1,15  ),W(1,8   ),GG ,AMP(9   ))             
      CALL FVIXXX(W(1,21  ),W(1,8   ),GG ,ZERO    ,ZERO    ,W(1,25  ))     
      CALL FVIXXX(W(1,25  ),W(1,2   ),GG ,ZERO    ,ZERO    ,W(1,26  ))     
      CALL IOVXXX(W(1,26  ),W(1,1   ),W(1,10  ),GWF ,AMP(10  ))            
      CALL JIOXXX(W(1,11  ),W(1,12  ),GAU ,ZERO    ,AWIDTH  ,W(1,27  ))    
      CALL VVVXXX(W(1,10  ),W(1,9   ),W(1,27  ),GWWA ,AMP(11  ))           
      CALL JIOXXX(W(1,11  ),W(1,12  ),GZU ,ZMASS   ,ZWIDTH  ,W(1,28  ))    
      CALL VVVXXX(W(1,10  ),W(1,9   ),W(1,28  ),GWWZ ,AMP(12  ))           
      CALL JVVXXX(W(1,10  ),W(1,9   ),GWWA ,ZERO    ,AWIDTH  ,W(1,         
     &     29  ))                                                          
      CALL IOVXXX(W(1,16  ),W(1,1   ),W(1,29  ),GAU ,AMP(13  ))            
      CALL JVVXXX(W(1,10  ),W(1,9   ),GWWZ ,ZMASS   ,ZWIDTH  ,W(1,         
     &     30  ))                                                          
      CALL IOVXXX(W(1,16  ),W(1,1   ),W(1,30  ),GZU ,AMP(14  ))            
      CALL IOVXXX(W(1,18  ),W(1,1   ),W(1,29  ),GAU ,AMP(15  ))            
      CALL IOVXXX(W(1,18  ),W(1,1   ),W(1,30  ),GZU ,AMP(16  ))            
      CALL JIOXXX(W(1,19  ),W(1,1   ),GAU ,ZERO    ,AWIDTH  ,W(1,31  ))    
      CALL VVVXXX(W(1,10  ),W(1,9   ),W(1,31  ),GWWA ,AMP(17  ))           
      CALL JIOXXX(W(1,19  ),W(1,1   ),GZU ,ZMASS   ,ZWIDTH  ,W(1,32  ))    
      CALL VVVXXX(W(1,10  ),W(1,9   ),W(1,32  ),GWWZ ,AMP(18  ))           
      CALL FVOXXX(W(1,12  ),W(1,2   ),GG ,ZERO    ,ZERO    ,W(1,33  ))     
      CALL IOVXXX(W(1,7   ),W(1,33  ),W(1,29  ),GAU ,AMP(19  ))            
      CALL IOVXXX(W(1,7   ),W(1,33  ),W(1,30  ),GZU ,AMP(20  ))            
      CALL FVOXXX(W(1,1   ),W(1,14  ),GG ,ZERO    ,ZERO    ,W(1,34  ))     
      CALL IOVXXX(W(1,7   ),W(1,34  ),W(1,29  ),GAU ,AMP(21  ))            
      CALL IOVXXX(W(1,7   ),W(1,34  ),W(1,30  ),GZU ,AMP(22  ))            
      CALL FVOXXX(W(1,1   ),W(1,2   ),GG ,ZERO    ,ZERO    ,W(1,35  ))     
      CALL IOVXXX(W(1,17  ),W(1,35  ),W(1,29  ),GAU ,AMP(23  ))            
      CALL IOVXXX(W(1,17  ),W(1,35  ),W(1,30  ),GZU ,AMP(24  ))            
      CALL FVOXXX(W(1,35  ),W(1,8   ),GG ,ZERO    ,ZERO    ,W(1,36  ))     
      CALL IOVXXX(W(1,7   ),W(1,36  ),W(1,29  ),GAU ,AMP(25  ))            
      CALL IOVXXX(W(1,7   ),W(1,36  ),W(1,30  ),GZU ,AMP(26  ))            
     ...
     &             +AMP(  28)-AMP(  29)-AMP(  30)-AMP(  31)
      matrix_uxg_epmumvevmxuxg = 0.D0 
      DO I = 1, NCOLOR
          ZTEMP = (0.D0,0.D0)
          DO J = 1, NCOLOR
              ZTEMP = ZTEMP + CF(J,I)*JAMP(J)
          ENDDO
          matrix_uxg_epmumvevmxuxg =matrix_uxg_epmumvevmxuxg+ZTEMP*DCONJG(JAMP(I))/DENOM(I)   
      ENDDO
      Do I = 1, NGRAPHS
