      SUBROUTINE smatrix_scx_epmumvevmxscx(P1,ANS)
C  
...
C  
C FOR PROCESS : s c~ -> e+ mu- ve vm~ s c~  
C  
C Crossing   1 is s c~ -> e+ mu- ve vm~ s c~  
      IMPLICIT NONE
C  
C CONSTANTS
C  
...
C  
      ...
      REAL*8 matrix_scx_epmumvevmxscx
...
C  
      ...
      common/to_amps_scx_epmumvevmxscx/  amp2,       jamp2
      ...
      common/to_matrix_scx_epmumvevmxscx/isum_hel, multi_channel
      INTEGER MAPCONFIG(0:LMAXCONFIGS), ICONFIG
      common/to_mconfigs_scx_epmumvevmxscx/mapconfig, iconfig
      DATA NTRY,IDUM /0,-1/
      integer iforest(2,-max_branch:-1,lmaxconfigs)
      common/to_forest_scx_epmumvevmxscx/ iforest
      include "configs.inc"
      ...
      IF (ISUM_HEL .EQ. 0 .OR. NTRY .LT. 10) THEN
          DO IHEL=1,NCOMB
              IF (GOODHEL(IHEL,IPROC) .OR. NTRY .LT. 2) THEN
                 T=matrix_scx_epmumvevmxscx(P ,NHEL(1,IHEL),JC(1))            
...
C                WRITE(*,*) ngood,IHEL,T
      ...
      REAL*8 FUNCTION matrix_scx_epmumvevmxscx(P,NHEL,IC)
C  
C Generated by MadGraph II Version 3.90. Updated 08/26/05               
C RETURNS AMPLITUDE SQUARED SUMMED/AVG OVER COLORS
...
C ----------
     ...
     &     23  ))                                                          
      ...
      CALL JIOXXX(W(1,17  ),W(1,7   ),GG ,ZERO    ,ZERO    ,W(1,27  ))     
      CALL IOVXXX(W(1,12  ),W(1,2   ),W(1,27  ),GG ,AMP(15  ))             
      CALL JIOXXX(W(1,8   ),W(1,14  ),GG ,ZERO    ,ZERO    ,W(1,28  ))     
      CALL FVOXXX(W(1,2   ),W(1,28  ),GG ,ZERO    ,ZERO    ,W(1,29  ))     
      CALL IOVXXX(W(1,1   ),W(1,29  ),W(1,10  ),GWF ,AMP(16  ))            
      CALL FVOXXX(W(1,2   ),W(1,10  ),GWF ,ZERO    ,ZERO    ,W(1,30  ))    
      CALL IOVXXX(W(1,1   ),W(1,30  ),W(1,27  ),GG ,AMP(17  ))             
      CALL FVIXXX(W(1,1   ),W(1,28  ),GG ,ZERO    ,ZERO    ,W(1,31  ))     
     ...
     &             +AMP(  11)+AMP(  12)+AMP(  13)+AMP(  14)
      ...
      matrix_scx_epmumvevmxscx = 0.D0 
      DO I = 1, NCOLOR
          ZTEMP = (0.D0,0.D0)
          DO J = 1, NCOLOR
              ZTEMP = ZTEMP + CF(J,I)*JAMP(J)
          ENDDO
          matrix_scx_epmumvevmxscx =matrix_scx_epmumvevmxscx+ZTEMP*DCONJG(JAMP(I))/DENOM(I)   
      ENDDO
      Do I = 1, NGRAPHS
