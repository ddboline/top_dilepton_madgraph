      SUBROUTINE smatrix_cxs_epmumvevmxscx(P1,ANS)
C  
...
C  
C FOR PROCESS : c~ s -> e+ mu- ve vm~ s c~  
C  
C Crossing   1 is c~ s -> e+ mu- ve vm~ s c~  
      IMPLICIT NONE
C  
C CONSTANTS
C  
...
C  
      ...
      REAL*8 matrix_cxs_epmumvevmxscx
...
C  
      ...
      common/to_amps_cxs_epmumvevmxscx/  amp2,       jamp2
      ...
      common/to_matrix_cxs_epmumvevmxscx/isum_hel, multi_channel
      INTEGER MAPCONFIG(0:LMAXCONFIGS), ICONFIG
      common/to_mconfigs_cxs_epmumvevmxscx/mapconfig, iconfig
      DATA NTRY,IDUM /0,-1/
      integer iforest(2,-max_branch:-1,lmaxconfigs)
      common/to_forest_cxs_epmumvevmxscx/ iforest
      include "configs.inc"
      ...
      IF (ISUM_HEL .EQ. 0 .OR. NTRY .LT. 10) THEN
          DO IHEL=1,NCOMB
              IF (GOODHEL(IHEL,IPROC) .OR. NTRY .LT. 2) THEN
                 T=matrix_cxs_epmumvevmxscx(P ,NHEL(1,IHEL),JC(1))            
...
C                WRITE(*,*) ngood,IHEL,T
      ...
      REAL*8 FUNCTION matrix_cxs_epmumvevmxscx(P,NHEL,IC)
C  
C Generated by MadGraph II Version 3.90. Updated 08/26/05               
C RETURNS AMPLITUDE SQUARED SUMMED/AVG OVER COLORS
...
C ----------
      ...
      CALL JIOXXX(W(1,2   ),W(1,7   ),GG ,ZERO    ,ZERO    ,W(1,11  ))     
      CALL FVIXXX(W(1,8   ),W(1,9   ),GWF ,ZERO    ,ZERO    ,W(1,12  ))    
      CALL FVIXXX(W(1,12  ),W(1,11  ),GG ,ZERO    ,ZERO    ,W(1,13  ))     
      CALL IOVXXX(W(1,13  ),W(1,1   ),W(1,10  ),GWF ,AMP(1   ))            
      CALL FVIXXX(W(1,8   ),W(1,11  ),GG ,ZERO    ,ZERO    ,W(1,14  ))     
      ...
      CALL FVIXXX(W(1,2   ),W(1,10  ),GWF ,ZERO    ,ZERO    ,W(1,17  ))    
      CALL FVOXXX(W(1,7   ),W(1,16  ),GG ,ZERO    ,ZERO    ,W(1,18  ))     
      CALL IOVXXX(W(1,17  ),W(1,18  ),W(1,9   ),GWF ,AMP(3   ))            
      CALL FVOXXX(W(1,7   ),W(1,9   ),GWF ,ZERO    ,ZERO    ,W(1,19  ))    
      CALL FVOXXX(W(1,19  ),W(1,16  ),GG ,ZERO    ,ZERO    ,W(1,20  ))     
      CALL IOVXXX(W(1,2   ),W(1,20  ),W(1,10  ),GWF ,AMP(4   ))            
      CALL JVVXXX(W(1,10  ),W(1,9   ),GWWA ,ZERO    ,AWIDTH  ,W(1,         
     &     21  ))                                                          
      CALL IOVXXX(W(1,2   ),W(1,18  ),W(1,21  ),GAD ,AMP(5   ))            
      CALL JVVXXX(W(1,10  ),W(1,9   ),GWWZ ,ZMASS   ,ZWIDTH  ,W(1,         
     &     22  ))                                                          
      CALL IOVXXX(W(1,2   ),W(1,18  ),W(1,22  ),GZD ,AMP(6   ))            
      CALL FVOXXX(W(1,1   ),W(1,11  ),GG ,ZERO    ,ZERO    ,W(1,23  ))     
      CALL IOVXXX(W(1,8   ),W(1,23  ),W(1,21  ),GAU ,AMP(7   ))            
      CALL IOVXXX(W(1,8   ),W(1,23  ),W(1,22  ),GZU ,AMP(8   ))            
      CALL IOVXXX(W(1,12  ),W(1,23  ),W(1,10  ),GWF ,AMP(9   ))            
      CALL JIOXXX(W(1,14  ),W(1,1   ),GAU ,ZERO    ,AWIDTH  ,W(1,24  ))    
      CALL VVVXXX(W(1,10  ),W(1,9   ),W(1,24  ),GWWA ,AMP(10  ))           
      CALL JIOXXX(W(1,14  ),W(1,1   ),GZU ,ZMASS   ,ZWIDTH  ,W(1,25  ))    
      CALL VVVXXX(W(1,10  ),W(1,9   ),W(1,25  ),GWWZ ,AMP(11  ))           
      CALL FVIXXX(W(1,2   ),W(1,16  ),GG ,ZERO    ,ZERO    ,W(1,26  ))     
      CALL IOVXXX(W(1,26  ),W(1,7   ),W(1,21  ),GAD ,AMP(12  ))            
      CALL IOVXXX(W(1,26  ),W(1,7   ),W(1,22  ),GZD ,AMP(13  ))            
      CALL IOVXXX(W(1,26  ),W(1,19  ),W(1,10  ),GWF ,AMP(14  ))            
      CALL FVOXXX(W(1,1   ),W(1,10  ),GWF ,ZERO    ,ZERO    ,W(1,27  ))    
      CALL JIOXXX(W(1,12  ),W(1,7   ),GG ,ZERO    ,ZERO    ,W(1,28  ))     
      CALL IOVXXX(W(1,2   ),W(1,27  ),W(1,28  ),GG ,AMP(15  ))             
      CALL JIOXXX(W(1,8   ),W(1,19  ),GG ,ZERO    ,ZERO    ,W(1,29  ))     
      CALL FVIXXX(W(1,2   ),W(1,29  ),GG ,ZERO    ,ZERO    ,W(1,30  ))     
      CALL IOVXXX(W(1,30  ),W(1,1   ),W(1,10  ),GWF ,AMP(16  ))            
      CALL IOVXXX(W(1,17  ),W(1,1   ),W(1,28  ),GG ,AMP(17  ))             
      CALL FVOXXX(W(1,1   ),W(1,29  ),GG ,ZERO    ,ZERO    ,W(1,31  ))     
      CALL IOVXXX(W(1,2   ),W(1,31  ),W(1,10  ),GWF ,AMP(18  ))            
      JAMP(   1) = -AMP(   1)-AMP(   2)-AMP(   3)-AMP(   4)-AMP(   5)
     &             -AMP(   6)-AMP(   7)-AMP(   8)-AMP(   9)-AMP(  10)
     &             -AMP(  11)-AMP(  12)-AMP(  13)-AMP(  14)
      JAMP(   2) = +AMP(  15)+AMP(  16)+AMP(  17)+AMP(  18)
      matrix_cxs_epmumvevmxscx = 0.D0 
      DO I = 1, NCOLOR
          ZTEMP = (0.D0,0.D0)
          DO J = 1, NCOLOR
              ZTEMP = ZTEMP + CF(J,I)*JAMP(J)
          ENDDO
          matrix_cxs_epmumvevmxscx =matrix_cxs_epmumvevmxscx+ZTEMP*DCONJG(JAMP(I))/DENOM(I)   
      ENDDO
      Do I = 1, NGRAPHS
