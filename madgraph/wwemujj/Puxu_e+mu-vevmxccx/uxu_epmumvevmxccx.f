      SUBROUTINE smatrix_uxu_epmumvevmxccx(P1,ANS)
C  
...
C  
C FOR PROCESS : u~ u -> e+ mu- ve vm~ c c~  
C  
C Crossing   1 is u~ u -> e+ mu- ve vm~ c c~  
      IMPLICIT NONE
C  
C CONSTANTS
C  
...
C  
      ...
      REAL*8 matrix_uxu_epmumvevmxccx
...
C  
      ...
      common/to_amps_uxu_epmumvevmxccx/  amp2,       jamp2
      ...
      common/to_matrix_uxu_epmumvevmxccx/isum_hel, multi_channel
      INTEGER MAPCONFIG(0:LMAXCONFIGS), ICONFIG
      common/to_mconfigs_uxu_epmumvevmxccx/mapconfig, iconfig
      DATA NTRY,IDUM /0,-1/
      integer iforest(2,-max_branch:-1,lmaxconfigs)
      common/to_forest_uxu_epmumvevmxccx/ iforest
      include "configs.inc"
      ...
      IF (ISUM_HEL .EQ. 0 .OR. NTRY .LT. 10) THEN
          DO IHEL=1,NCOMB
              IF (GOODHEL(IHEL,IPROC) .OR. NTRY .LT. 2) THEN
                 T=matrix_uxu_epmumvevmxccx(P ,NHEL(1,IHEL),JC(1))            
...
C                WRITE(*,*) ngood,IHEL,T
      ...
      REAL*8 FUNCTION matrix_uxu_epmumvevmxccx(P,NHEL,IC)
C  
C Generated by MadGraph II Version 3.90. Updated 08/26/05               
C RETURNS AMPLITUDE SQUARED SUMMED/AVG OVER COLORS
...
C ----------
      ...
      CALL IOVXXX(W(1,13  ),W(1,1   ),W(1,11  ),GG ,AMP(1   ))             
      CALL FVOXXX(W(1,1   ),W(1,10  ),GWF ,ZERO    ,ZERO    ,W(1,14  ))    
      CALL FVIXXX(W(1,2   ),W(1,11  ),GG ,ZERO    ,ZERO    ,W(1,15  ))     
      CALL IOVXXX(W(1,15  ),W(1,14  ),W(1,9   ),GWF ,AMP(2   ))            
      CALL IOVXXX(W(1,12  ),W(1,14  ),W(1,11  ),GG ,AMP(3   ))             
      CALL JVVXXX(W(1,10  ),W(1,9   ),GWWA ,ZERO    ,AWIDTH  ,W(1,         
     &     16  ))                                                          
      CALL FVOXXX(W(1,1   ),W(1,11  ),GG ,ZERO    ,ZERO    ,W(1,17  ))     
      CALL IOVXXX(W(1,2   ),W(1,17  ),W(1,16  ),GAU ,AMP(4   ))            
      CALL JVVXXX(W(1,10  ),W(1,9   ),GWWZ ,ZMASS   ,ZWIDTH  ,W(1,         
     &     18  ))                                                          
      CALL IOVXXX(W(1,2   ),W(1,17  ),W(1,18  ),GZU ,AMP(5   ))            
      CALL IOVXXX(W(1,15  ),W(1,1   ),W(1,16  ),GAU ,AMP(6   ))            
      CALL IOVXXX(W(1,15  ),W(1,1   ),W(1,18  ),GZU ,AMP(7   ))            
      ...
      CALL IOVXXX(W(1,24  ),W(1,7   ),W(1,18  ),GZU ,AMP(12  ))            
     ...
     &             +AMP(  11)+AMP(  12)+AMP(  13)+AMP(  14)
      matrix_uxu_epmumvevmxccx = 0.D0 
      DO I = 1, NCOLOR
          ZTEMP = (0.D0,0.D0)
          DO J = 1, NCOLOR
              ZTEMP = ZTEMP + CF(J,I)*JAMP(J)
          ENDDO
          matrix_uxu_epmumvevmxccx =matrix_uxu_epmumvevmxccx+ZTEMP*DCONJG(JAMP(I))/DENOM(I)   
      ENDDO
      Do I = 1, NGRAPHS
