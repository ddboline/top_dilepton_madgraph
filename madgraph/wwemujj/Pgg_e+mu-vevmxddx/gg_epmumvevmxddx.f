      SUBROUTINE smatrix_gg_epmumvevmxddx(P1,ANS)
C  
...
C  
C FOR PROCESS : g g -> e+ mu- ve vm~ d d~  
C  
C Crossing   1 is g g -> e+ mu- ve vm~ d d~  
      IMPLICIT NONE
C  
C CONSTANTS
C  
...
C  
      ...
      REAL*8 matrix_gg_epmumvevmxddx
...
C  
      ...
      common/to_amps_gg_epmumvevmxddx/  amp2,       jamp2
      ...
      common/to_matrix_gg_epmumvevmxddx/isum_hel, multi_channel
      INTEGER MAPCONFIG(0:LMAXCONFIGS), ICONFIG
      common/to_mconfigs_gg_epmumvevmxddx/mapconfig, iconfig
      DATA NTRY,IDUM /0,-1/
      integer iforest(2,-max_branch:-1,lmaxconfigs)
      common/to_forest_gg_epmumvevmxddx/ iforest
      include "configs.inc"
      ...
      IF (ISUM_HEL .EQ. 0 .OR. NTRY .LT. 10) THEN
          DO IHEL=1,NCOMB
              IF (GOODHEL(IHEL,IPROC) .OR. NTRY .LT. 2) THEN
                 T=matrix_gg_epmumvevmxddx(P ,NHEL(1,IHEL),JC(1))            
...
C                WRITE(*,*) ngood,IHEL,T
      ...
      REAL*8 FUNCTION matrix_gg_epmumvevmxddx(P,NHEL,IC)
C  
C Generated by MadGraph II Version 3.90. Updated 08/26/05               
C RETURNS AMPLITUDE SQUARED SUMMED/AVG OVER COLORS
...
C ----------
      ...
      CALL FVOXXX(W(1,7   ),W(1,2   ),GG ,ZERO    ,ZERO    ,W(1,11  ))     
      CALL FVIXXX(W(1,8   ),W(1,1   ),GG ,ZERO    ,ZERO    ,W(1,12  ))     
      CALL FVOXXX(W(1,11  ),W(1,9   ),GWF ,ZERO    ,ZERO    ,W(1,13  ))    
      CALL IOVXXX(W(1,12  ),W(1,13  ),W(1,10  ),GWF ,AMP(1   ))            
      CALL FVIXXX(W(1,8   ),W(1,10  ),GWF ,ZERO    ,ZERO    ,W(1,14  ))    
      CALL IOVXXX(W(1,14  ),W(1,13  ),W(1,1   ),GG ,AMP(2   ))             
      CALL FVOXXX(W(1,7   ),W(1,9   ),GWF ,ZERO    ,ZERO    ,W(1,15  ))    
      CALL FVOXXX(W(1,15  ),W(1,2   ),GG ,ZERO    ,ZERO    ,W(1,16  ))     
      CALL IOVXXX(W(1,12  ),W(1,16  ),W(1,10  ),GWF ,AMP(3   ))            
      CALL IOVXXX(W(1,14  ),W(1,16  ),W(1,1   ),GG ,AMP(4   ))             
      CALL FVOXXX(W(1,7   ),W(1,1   ),GG ,ZERO    ,ZERO    ,W(1,17  ))     
      CALL FVIXXX(W(1,8   ),W(1,2   ),GG ,ZERO    ,ZERO    ,W(1,18  ))     
      CALL FVOXXX(W(1,17  ),W(1,9   ),GWF ,ZERO    ,ZERO    ,W(1,19  ))    
      CALL IOVXXX(W(1,18  ),W(1,19  ),W(1,10  ),GWF ,AMP(5   ))            
      CALL IOVXXX(W(1,14  ),W(1,19  ),W(1,2   ),GG ,AMP(6   ))             
      CALL FVOXXX(W(1,15  ),W(1,1   ),GG ,ZERO    ,ZERO    ,W(1,20  ))     
      CALL IOVXXX(W(1,18  ),W(1,20  ),W(1,10  ),GWF ,AMP(7   ))            
      CALL IOVXXX(W(1,14  ),W(1,20  ),W(1,2   ),GG ,AMP(8   ))             
      CALL JIOXXX(W(1,18  ),W(1,17  ),GAD ,ZERO    ,AWIDTH  ,W(1,21  ))    
      CALL VVVXXX(W(1,10  ),W(1,9   ),W(1,21  ),GWWA ,AMP(9   ))           
      CALL JIOXXX(W(1,18  ),W(1,17  ),GZD ,ZMASS   ,ZWIDTH  ,W(1,22  ))    
     ...
     &     24  ))                                                          
      CALL IOVXXX(W(1,8   ),W(1,23  ),W(1,24  ),GAD ,AMP(11  ))            
      CALL JVVXXX(W(1,10  ),W(1,9   ),GWWZ ,ZMASS   ,ZWIDTH  ,W(1,         
     &     25  ))                                                          
      CALL IOVXXX(W(1,8   ),W(1,23  ),W(1,25  ),GZD ,AMP(12  ))            
      CALL IOVXXX(W(1,14  ),W(1,23  ),W(1,9   ),GWF ,AMP(13  ))            
      CALL JIOXXX(W(1,12  ),W(1,11  ),GAD ,ZERO    ,AWIDTH  ,W(1,26  ))    
      CALL VVVXXX(W(1,10  ),W(1,9   ),W(1,26  ),GWWA ,AMP(14  ))           
      CALL JIOXXX(W(1,12  ),W(1,11  ),GZD ,ZMASS   ,ZWIDTH  ,W(1,27  ))    
      CALL VVVXXX(W(1,10  ),W(1,9   ),W(1,27  ),GWWZ ,AMP(15  ))           
      CALL FVOXXX(W(1,11  ),W(1,1   ),GG ,ZERO    ,ZERO    ,W(1,28  ))     
      CALL IOVXXX(W(1,8   ),W(1,28  ),W(1,24  ),GAD ,AMP(16  ))            
      CALL IOVXXX(W(1,8   ),W(1,28  ),W(1,25  ),GZD ,AMP(17  ))            
      CALL IOVXXX(W(1,14  ),W(1,28  ),W(1,9   ),GWF ,AMP(18  ))            
      CALL FVIXXX(W(1,12  ),W(1,2   ),GG ,ZERO    ,ZERO    ,W(1,29  ))     
      CALL IOVXXX(W(1,29  ),W(1,7   ),W(1,24  ),GAD ,AMP(19  ))            
      CALL IOVXXX(W(1,29  ),W(1,7   ),W(1,25  ),GZD ,AMP(20  ))            
      CALL FVIXXX(W(1,18  ),W(1,1   ),GG ,ZERO    ,ZERO    ,W(1,30  ))     
      CALL IOVXXX(W(1,30  ),W(1,7   ),W(1,24  ),GAD ,AMP(21  ))            
      CALL IOVXXX(W(1,30  ),W(1,7   ),W(1,25  ),GZD ,AMP(22  ))            
      CALL JVVXXX(W(1,1   ),W(1,2   ),G ,ZERO    ,ZERO    ,W(1,31  ))      
      CALL FVOXXX(W(1,7   ),W(1,31  ),GG ,ZERO    ,ZERO    ,W(1,32  ))     
      CALL JIOXXX(W(1,8   ),W(1,32  ),GAD ,ZERO    ,AWIDTH  ,W(1,33  ))    
      CALL VVVXXX(W(1,10  ),W(1,9   ),W(1,33  ),GWWA ,AMP(23  ))           
      CALL JIOXXX(W(1,8   ),W(1,32  ),GZD ,ZMASS   ,ZWIDTH  ,W(1,34  ))    
      CALL VVVXXX(W(1,10  ),W(1,9   ),W(1,34  ),GWWZ ,AMP(24  ))           
      CALL IOVXXX(W(1,14  ),W(1,32  ),W(1,9   ),GWF ,AMP(25  ))            
      CALL FVIXXX(W(1,8   ),W(1,31  ),GG ,ZERO    ,ZERO    ,W(1,35  ))     
      CALL IOVXXX(W(1,35  ),W(1,7   ),W(1,24  ),GAD ,AMP(26  ))            
      CALL IOVXXX(W(1,35  ),W(1,7   ),W(1,25  ),GZD ,AMP(27  ))            
      CALL IOVXXX(W(1,29  ),W(1,15  ),W(1,10  ),GWF ,AMP(28  ))            
      CALL IOVXXX(W(1,30  ),W(1,15  ),W(1,10  ),GWF ,AMP(29  ))            
      CALL IOVXXX(W(1,35  ),W(1,15  ),W(1,10  ),GWF ,AMP(30  ))            
      CALL IOVXXX(W(1,14  ),W(1,15  ),W(1,31  ),GG ,AMP(31  ))             
      JAMP(   1) = -AMP(   1)-AMP(   2)-AMP(   3)-AMP(   4)-AMP(  14)
     ...
     &             -AMP(  27)-AMP(  29)-AMP(  30)-AMP(  31)
      matrix_gg_epmumvevmxddx = 0.D0 
      DO I = 1, NCOLOR
          ZTEMP = (0.D0,0.D0)
          DO J = 1, NCOLOR
              ZTEMP = ZTEMP + CF(J,I)*JAMP(J)
          ENDDO
          matrix_gg_epmumvevmxddx =matrix_gg_epmumvevmxddx+ZTEMP*DCONJG(JAMP(I))/DENOM(I)   
      ENDDO
      Do I = 1, NGRAPHS
