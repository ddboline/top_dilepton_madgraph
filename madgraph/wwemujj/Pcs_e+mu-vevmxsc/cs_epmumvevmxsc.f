      SUBROUTINE smatrix_cs_epmumvevmxsc(P1,ANS)
C  
...
C  
      ...
      common/to_amps_cs_epmumvevmxsc/  amp2,       jamp2
      ...
      common/to_matrix_cs_epmumvevmxsc/isum_hel, multi_channel
      INTEGER MAPCONFIG(0:LMAXCONFIGS), ICONFIG
      common/to_mconfigs_cs_epmumvevmxsc/mapconfig, iconfig
      DATA NTRY,IDUM /0,-1/
      integer iforest(2,-max_branch:-1,lmaxconfigs)
      common/to_forest_cs_epmumvevmxsc/ iforest
      include "configs.inc"
      ...
      IF (ISUM_HEL .EQ. 0 .OR. NTRY .LT. 10) THEN
          DO IHEL=1,NCOMB
              IF (GOODHEL(IHEL,IPROC) .OR. NTRY .LT. 2) THEN
                 T=matrix_cs_epmumvevmxsc(P ,NHEL(1,IHEL),JC(1))            
...
C                WRITE(*,*) ngood,IHEL,T
      ...
      REAL*8 FUNCTION matrix_cs_epmumvevmxsc(P,NHEL,IC)
C  
C Generated by MadGraph II Version 3.90. Updated 08/26/05               
C RETURNS AMPLITUDE SQUARED SUMMED/AVG OVER COLORS
...
C ----------
      ...
      CALL FVOXXX(W(1,8   ),W(1,10  ),GWF ,ZERO    ,ZERO    ,W(1,15  ))    
      CALL FVIXXX(W(1,1   ),W(1,9   ),GWF ,ZERO    ,ZERO    ,W(1,16  ))    
      CALL IOVXXX(W(1,16  ),W(1,15  ),W(1,14  ),GG ,AMP(2   ))             
      CALL FVOXXX(W(1,8   ),W(1,14  ),GG ,ZERO    ,ZERO    ,W(1,17  ))     
      CALL IOVXXX(W(1,16  ),W(1,17  ),W(1,10  ),GWF ,AMP(3   ))            
     ...
     &     21  ))                                                          
      ...
      CALL FVIXXX(W(1,1   ),W(1,14  ),GG ,ZERO    ,ZERO    ,W(1,22  ))     
      CALL IOVXXX(W(1,22  ),W(1,8   ),W(1,20  ),GAU ,AMP(7   ))            
      CALL IOVXXX(W(1,22  ),W(1,8   ),W(1,21  ),GZU ,AMP(8   ))            
      CALL IOVXXX(W(1,22  ),W(1,15  ),W(1,9   ),GWF ,AMP(9   ))            
      CALL JIOXXX(W(1,1   ),W(1,17  ),GAU ,ZERO    ,AWIDTH  ,W(1,23  ))    
      CALL VVVXXX(W(1,10  ),W(1,9   ),W(1,23  ),GWWA ,AMP(10  ))           
      CALL JIOXXX(W(1,1   ),W(1,17  ),GZU ,ZMASS   ,ZWIDTH  ,W(1,24  ))    
      ...
      CALL JIOXXX(W(1,16  ),W(1,7   ),GG ,ZERO    ,ZERO    ,W(1,26  ))     
      CALL IOVXXX(W(1,12  ),W(1,8   ),W(1,26  ),GG ,AMP(15  ))             
      CALL JIOXXX(W(1,2   ),W(1,15  ),GG ,ZERO    ,ZERO    ,W(1,27  ))     
      CALL IOVXXX(W(1,16  ),W(1,7   ),W(1,27  ),GG ,AMP(16  ))             
      CALL JIOXXX(W(1,1   ),W(1,18  ),GG ,ZERO    ,ZERO    ,W(1,28  ))     
      CALL IOVXXX(W(1,12  ),W(1,8   ),W(1,28  ),GG ,AMP(17  ))             
      CALL IOVXXX(W(1,2   ),W(1,15  ),W(1,28  ),GG ,AMP(18  ))             
      JAMP(   1) = +AMP(   1)+AMP(   2)+AMP(   3)+AMP(   4)+AMP(   5)
     &             +AMP(   6)+AMP(   7)+AMP(   8)+AMP(   9)+AMP(  10)
     &             +AMP(  11)+AMP(  12)+AMP(  13)+AMP(  14)
      JAMP(   2) = -AMP(  15)-AMP(  16)-AMP(  17)-AMP(  18)
      matrix_cs_epmumvevmxsc = 0.D0 
      DO I = 1, NCOLOR
          ZTEMP = (0.D0,0.D0)
          DO J = 1, NCOLOR
              ZTEMP = ZTEMP + CF(J,I)*JAMP(J)
          ENDDO
          matrix_cs_epmumvevmxsc =matrix_cs_epmumvevmxsc+ZTEMP*DCONJG(JAMP(I))/DENOM(I)   
      ENDDO
      Do I = 1, NGRAPHS
